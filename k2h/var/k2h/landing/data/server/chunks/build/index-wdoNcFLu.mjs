...
import { useSSRContext, defineComponent, toRef, computed, ref, watch, withAsyncContext, withCtx, createVNode, openBlock, createBlock, Fragment, renderList, createCommentVNode, createTextVNode, mergeProps, unref, createSlots, renderSlot, toDisplayString, toRaw } from 'vue';
...
import { x as mergeConfig, z as appConfig, C as __nuxt_component_1$3, P as __nuxt_component_0$9, F as useUI, K as get, _ as _export_sfc, u as useSeoMeta, Y as useAppConfig, V as useCartStore, W as __nuxt_component_0$4, a2 as __nuxt_component_1$2, Q as __nuxt_component_2$3 } from './server.mjs';
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          ...
          if (_push2) {
            ...
            if (__props.orientation === "horizontal") {
              ...
              if (((_a = __props.features) == null ? undefined : _a.length) || _ctx.$slots.features) {
                _push2(`<div class="flex-1"${_scopeId}>`);
                ssrRenderSlot(_ctx.$slots, "features", {}, () => {
                  var _a2;
                  if ((_a2 = __props.features) == null ? undefined : _a2.length) {
            ...
            if (__props.orientation === "vertical") {
              ...
              _push2(`</div>`);
              if (((_b = __props.features) == null ? undefined : _b.length) || _ctx.$slots.features) {
            ...
            if (__props.button) {
              _push2(ssrRenderComponent(_component_UButton, mergeProps({ block: true, size: "lg", ...__props.button }, {
                onClick: (_c = __props.button) == null ? undefined : _c.click
              }), null, _parent2, _scopeId));
            } else {
              _push2(`<!---->`);
            }
            ...
            return [
              createVNode("div", {
                ...
                __props.orientation === "horizontal" ? (openBlock(), createBlock(Fragment, { key: 1 }, [
                  ...
                  ((_d = __props.features) == null ? undefined : _d.length) || _ctx.$slots.features ? (openBlock(), createBlock("div", {
                    key: 0,
                    class: "flex-1"
                  }, [
                    renderSlot(_ctx.$slots, "features", {}, () => {
                      var _a2;
                      return [
                        ((_a2 = __props.features) == null ? undefined : _a2.length) ? (openBlock(), createBlock("ul", {
                          key: 0,
              ...
              __props.orientation === "vertical" ? (openBlock(), createBlock(Fragment, { key: 0 }, [
                ...
                ((_e = __props.features) == null ? undefined : _e.length) || _ctx.$slots.features ? (openBlock(), createBlock("div", {
                  key: 0,
              ...
              createVNode("div", {
                ...
                __props.button ? (openBlock(), createBlock(_component_UButton, mergeProps({ key: 1 }, { block: true, size: "lg", ...__props.button }, {
                  onClick: (_f = __props.button) == null ? undefined : _f.click
...
const _sfc_main$1 = defineComponent({
  ...
  setup(props, { emit, attrs: $attrs }) {
    ...
    const rows = computed(() => {
      var _a;
      if (!((_a = sort.value) == null ? undefined : _a.column) || props.sortMode === "manual") {
        return props.rows;
      }
      ...
      return props.rows.slice().sort((a, b) => {
        ...
        const sort2 = ((_a2 = columns.value.find((col) => col.key === column)) == null ? undefined : _a2.sort) ?? defaultSort;
    ...
    function onSelect(row) {
      const selection = (undefined).getSelection();
    ...
    function isExpanded(row) {
      var _a;
      return ((_a = expand.value) == null ? undefined : _a.openedRows) ? expand.value.openedRows.some((openedRow) => compare(openedRow, row)) : false;
    }
...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  ...
  if (_ctx.loadingState && _ctx.loading && !_ctx.rows.length) {
    ...
    ssrRenderList(_ctx.rows, (row, index) => {
      _push(`<!--[--><tr class="${ssrRenderClass([_ctx.ui.tr.base, _ctx.isSelected(row) && _ctx.ui.tr.selected, _ctx.isExpanded(row) && _ctx.ui.tr.expanded, _ctx.$attrs.onSelect && _ctx.ui.tr.active, row == null ? undefined : row.class])}">`);
      if (_ctx.expand) {
      ...
      ssrRenderList(_ctx.columns, (column, subIndex) => {
        var _a;
        _push(`<td class="${ssrRenderClass([_ctx.ui.td.base, _ctx.ui.td.padding, _ctx.ui.td.color, _ctx.ui.td.font, _ctx.ui.td.size, column == null ? undefined : column.rowClass, (_a = row[column.key]) == null ? undefined : _a.class, column.key === "select" && _ctx.ui.checkbox.padding])}">`);
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  async setup(__props) {
    ...
    const items = [{
      ...
      feature: "E-Mail Konten",
      weblite: "1",
      webpro: "3",
      webmax: "10"
    }, {
      feature: "E-Mail Adressen",
      weblite: "1",
      webpro: "3",
      webmax: "10"
    }, {
      ...
      feature: "FTP-Benutzer",
      weblite: "1",
      webpro: "1",
      webmax: "3"
    }, {
      feature: "Antivirus / Antispam",
      weblite: "Ja",
      webpro: "Ja",
      webmax: "Ja"
    }, {
      ...
      feature: "PHP Memory Limit",
      weblite: "128 M",
      webpro: "256 M",
      webmax: "512 M"
    }, {
      feature: "PHP Upload Max Filesize",
      weblite: "64 M",
      webpro: "128 M",
      webmax: "256 M"
    }, {
      feature: "Kostenloses SSL-Zertifikat",
      weblite: "Ja",
      webpro: "Ja",
      webmax: "Ja"
    }, {
      ...
      feature: "Datenbank-Fernzugriff",
      weblite: "",
      webpro: "Ja",
      webmax: "Ja"
    }, {
      feature: "Catch-All E-Mail",
      weblite: "",
      webpro: "Ja",
      webmax: "Ja"
    }, {
      feature: "Geplante Aufgaben",
      weblite: "",
      webpro: "1",
      webmax: "∞"
    }, {
      feature: "SSL/TLS Zertifikatsmanager",
      weblite: "",
      webpro: "",
      webmax: "Ja"
    }];
    ...
    const fetchPackageInfo = async () => {
      try {
        const response = await fetch("http://localhost:80/api/user/getWebspaceInfo");
    ...
    useSeoMeta({
      title: "Webspaces",
      ogTitle: "Webspaces",
      description: "Durchstöbere unsere Webhosting-Pakete!",
      ogDescription: "Durchstöbere unsere Webhosting-Pakete!"
    });
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_component_ULandingSection, {
        headline: "Produkte > Webspaces",
        title: "Durchstöbere unsere Webhosting-Pakete!",
        align: "left"
      }, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<p class="opacity-50"${_scopeId}>Ein leistungsstarker Webspace ist die Basis jeder erfolgreichen Website. Egal, ob Sie eine Unternehmenswebsite, einen Online-Shop oder eine private Seite betreiben – unsere Webspaces bieten Ihnen die perfekte Kombination aus Performance, Sicherheit und Benutzerfreundlichkeit. </p>`);
          } else {
            return [
              createVNode("p", { class: "opacity-50" }, "Ein leistungsstarker Webspace ist die Basis jeder erfolgreichen Website. Egal, ob Sie eine Unternehmenswebsite, einen Online-Shop oder eine private Seite betreiben – unsere Webspaces bieten Ihnen die perfekte Kombination aus Performance, Sicherheit und Benutzerfreundlichkeit. ")
            ];
          }
        }),
        _: 1
          ...
          if (_push2) {
            ...
            ssrRenderList(packages, (packageItem, index) => {
              _push2(ssrRenderComponent(_component_UPricingCard, {
                ...
                discount: "",
                cycle: "/Monat",
                button: { label: "In den Warenkorb", click: () => buy(index + 1) },
      ...
      _push(ssrRenderComponent(_component_UAlert, {
        class: "mt-4",
        actions: [{ variant: "solid", color: "primary", label: "Wunschdomain sichern", to: "/products/domain" }]
      }, {
        title: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<span class="text-lg"${_scopeId}>Domain benötigt?</span>`);
          } else {
            return [
              createVNode("span", { class: "text-lg" }, "Domain benötigt?")
            ];
          }
        }),
        description: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(` Für eine erfolgreiche Online-Präsenz empfehlen wir, zusätzlich zu Ihrem Webhosting-Paket eine passende Domain zu sichern (beispielsweise example.org). `);
          } else {
            return [
              createTextVNode(" Für eine erfolgreiche Online-Präsenz empfehlen wir, zusätzlich zu Ihrem Webhosting-Paket eine passende Domain zu sichern (beispielsweise example.org). ")
            ];
          }
        }),
        _: 1
...
//# sourceMappingURL=index-wdoNcFLu.mjs.map
