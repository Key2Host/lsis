import { F as useUI, ae as __nuxt_component_0$7 } from './server.mjs';
import { useSSRContext, computed, ref, defineComponent, toRef, mergeProps, unref, withCtx, createTextVNode, toDisplayString } from 'vue';
...
const _useShortcuts = () => {
  ...
  const usingInput = computed(() => {
    var _a, _b, _c;
    const tagName = (_a = activeElement.value) == null ? undefined : _a.tagName;
    const contentEditable = (_b = activeElement.value) == null ? undefined : _b.contentEditable;
    const usingInput2 = !!(tagName === "INPUT" || tagName === "TEXTAREA" || contentEditable === "true" || contentEditable === "plaintext-only");
    if (usingInput2) {
      return ((_c = activeElement.value) == null ? undefined : _c.name) || true;
    }
    return false;
  });
  return {
...
//# sourceMappingURL=Shortcut-CoSQf8w2.mjs.map
