import { L as withLeadingSlash, C as joinURL, I as withoutTrailingSlash, M as withBase, N as hash } from '../nitro/nitro.mjs';
import { af as useRuntimeConfig, ag as useRequestEvent } from './server.mjs';
...
const createQueryFetch = () => async (query) => {
  ...
  if (shouldUseClientDB()) {
    const db = await import('./client-db-BQrnEyHU.mjs').then((m) => m.useContentDatabase());
...
//# sourceMappingURL=query-BPOdX6Mi.mjs.map
