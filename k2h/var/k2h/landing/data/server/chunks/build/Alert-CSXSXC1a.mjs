...
import { x as mergeConfig, z as appConfig, F as useUI, _ as _export_sfc, I as useFormGroup, J as twMerge, C as __nuxt_component_1$3, D as __nuxt_component_4$3, P as __nuxt_component_0$9 } from './server.mjs';
import { ssrRenderAttrs, ssrRenderSlot, ssrRenderClass, ssrRenderStyle, ssrInterpolate, ssrRenderList, ssrLooseContain, ssrGetDynamicModelProps, ssrRenderAttr, ssrRenderComponent } from 'vue/server-renderer';
  ...
  setup(props) {
    ...
    const progressClass = computed(() => {
      ...
      const classes = [
        ...
        (_a = ui.value.progress.color) == null ? undefined : _a.replaceAll("{color}", props.color),
    ...
    const stepsClass = computed(() => {
      ...
      return twJoin(
        ui.value.steps.base,
        (_a = ui.value.steps.color) == null ? undefined : _a.replaceAll("{color}", props.color),
...
function _sfc_ssrRender$2(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  ...
  }, { value: _ctx.value, max: _ctx.realMax, ..._ctx.attrs }))} data-v-916eeb3a>${ssrInterpolate(_ctx.percent !== undefined ? `${Math.round(_ctx.percent)}%` : undefined)}</progress>`);
  if (_ctx.isSteps) {
...
export { __nuxt_component_2 as _, __nuxt_component_0 as a, __nuxt_component_5 as b };
//# sourceMappingURL=Alert-CSXSXC1a.mjs.map
