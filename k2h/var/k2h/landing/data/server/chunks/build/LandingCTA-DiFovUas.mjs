import { F as useUI, W as __nuxt_component_0$4, P as __nuxt_component_0$9 } from './server.mjs';
import { useSSRContext, defineComponent, computed, toRef, mergeProps, unref, withCtx, createVNode, openBlock, createBlock, renderSlot, createTextVNode, toDisplayString, createCommentVNode, Fragment, renderList } from 'vue';
      ...
      _push(ssrRenderComponent(_component_UCard, mergeProps({
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          ...
          if (_push2) {
            ...
            if (((_a = __props.links) == null ? undefined : _a.length) || _ctx.$slots.links) {
            ...
            return [
              createVNode("div", {
                ...
                ((_b = __props.links) == null ? undefined : _b.length) || _ctx.$slots.links ? (openBlock(), createBlock("div", {
                  key: 2,
...
//# sourceMappingURL=LandingCTA-DiFovUas.mjs.map
