...
import { u as useSeoMeta, V as useCartStore, a9 as __nuxt_component_2$1 } from './server.mjs';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    const fetchPackageInfo = async () => {
      try {
        const response = await fetch("http://localhost:80/api/user/getDomainInfo");
...
//# sourceMappingURL=index-DNF2L0oT.mjs.map
