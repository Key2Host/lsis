...
import { hasInjectionContext, inject, version, ref, watchEffect, watch, getCurrentInstance, shallowRef, toRef, onServerPrefetch, isRef, defineAsyncComponent, useAttrs, computed, toValue, defineComponent, useSSRContext, onMounted, cloneVNode, h as h$1, Fragment, provide, onUnmounted, unref, Teleport, reactive, nextTick, normalizeClass, useId, useSlots, shallowReactive, Suspense, createElementBlock, resolveComponent, createVNode, resolveDynamicComponent, mergeProps, withCtx, renderSlot, openBlock, createBlock, Transition, createCommentVNode, createTextVNode, toDisplayString, withAsyncContext, createSlots, renderList, withKeys, withDirectives, vShow, withModifiers, createApp, effectScope, getCurrentScope, onErrorCaptured, isReadonly, toRaw, isShallow, isReactive } from 'vue';
import { $ as $fetch$1, j as baseURL, k as klona, l as parse, m as getRequestHeader, n as defuFn, o as defu, p as publicAssetsURL, q as destr, s as isEqual, t as setCookie, v as getCookie, w as deleteCookie, x as parseQuery, y as createDefu, z as getContext, A as createHooks, c as createError$1, B as hasProtocol, C as joinURL, D as diff, E as isScriptProtocol, F as withQuery, G as sanitizeStatusCode, H as withTrailingSlash, I as withoutTrailingSlash, J as toRouteMatcher, K as createRouter$1 } from '../nitro/nitro.mjs';
...
async function applyPlugins(nuxtApp, plugins2) {
  ...
  async function executePlugin(plugin2) {
    var _a3;
    const unresolvedPluginsForThisPlugin = ((_a3 = plugin2.dependsOn) == null ? undefined : _a3.filter((name) => plugins2.some((p2) => p2._name === name) && !resolvedPlugins.includes(name))) ?? [];
...
const interpolatePath = (route, match) => {
  return match.path.replace(ROUTE_KEY_PARENTHESES_RE$1, "$1").replace(ROUTE_KEY_SYMBOLS_RE$1, "$1").replace(ROUTE_KEY_NORMAL_RE$1, (r2) => {
    var _a2;
    return ((_a2 = route.params[r2.slice(1)]) == null ? undefined : _a2.toString()) || "";
  });
};
const generateRouteKey$1 = (routeProps, override) => {
  const matchedRoute = routeProps.route.matched.find((m2) => {
    var _a2;
    return ((_a2 = m2.components) == null ? undefined : _a2.default) === routeProps.Component.type;
  });
...
const _routes = [
  {
    ...
    component: () => import('./failed-DR7LiSlp.mjs')
  },
  {
    name: "checkout",
    path: "/checkout",
  ...
  },
  {
    ...
    component: () => import('./success-CqBxG9jJ.mjs')
  },
  {
    name: "company-milestones",
    path: "/company/milestones",
    component: () => import('./milestones-DoaxbD62.mjs')
  },
  {
    name: "company-office",
    path: "/company/office",
    component: () => import('./office-BsqD0pTM.mjs')
  },
  {
  ...
  },
  {
    name: "legal-notice",
    path: "/legal/notice",
    component: () => import('./notice-DKvVLKIX.mjs')
  },
  {
    name: "legal-privacy",
    path: "/legal/privacy",
    component: () => import('./privacy-DStWWSSQ.mjs')
  },
  {
    name: "legal-tos",
    path: "/legal/tos",
    component: () => import('./tos-LVvWyYJj.mjs')
  },
  {
    name: "newsroom-id",
    path: "/newsroom/:id()",
  ...
  },
  {
    ...
    component: () => import('./index-D8SjzLO5.mjs')
  },
  {
  ...
  },
  {
    ...
    component: () => import('./index-Cm0ZE63u.mjs')
  },
  {
    name: "products-vps-root",
    path: "/products/vps-root",
    component: () => import('./index-Bl3ZGXIN.mjs')
  },
  {
...
function isChangingPage(to, from) {
  ...
  const areComponentsSame = to.matched.every(
    (comp, index2) => {
      var _a2, _b;
      return comp.components && comp.components.default === ((_b = (_a2 = from.matched[index2]) == null ? undefined : _a2.components) == null ? undefined : _b.default);
    }
  );
...
function findHashPosition(hash2) {
  const el = (undefined).querySelector(hash2);
  if (el) {
...
const plugin$1 = /* @__PURE__ */ defineNuxtPlugin({
  ...
  async setup(nuxtApp) {
    ...
    const history2 = ((_a2 = routerOptions.history) == null ? undefined : _a2.call(routerOptions, routerBase)) ?? createMemoryHistory(routerBase);
    ...
    router.beforeEach(async (to, from) => {
      ...
      if (!((_a3 = nuxtApp.ssrContext) == null ? undefined : _a3.islandContext)) {
        ...
        for (const entry2 of middlewareEntries) {
          const middleware = typeof entry2 === "string" ? nuxtApp._middleware.named[entry2] || await ((_b2 = namedMiddleware[entry2]) == null ? undefined : _b2.call(namedMiddleware).then((r2) => r2.default || r2)) : entry2;
          if (!middleware) {
  ...
  return defineComponent({
    ...
    setup(props, { slots }) {
      ...
      return () => {
        ...
        return h$1("a", { ref: el, href: href.value || null, rel, target }, (_a2 = slots.default) == null ? undefined : _a2.call(slots));
      };
    }
  });
}
...
const _0_siteConfig_jtc2qNDx4l = /* @__PURE__ */ defineNuxtPlugin({
  ...
  async setup(nuxtApp) {
    ...
    {
      const context = (_a2 = useRequestEvent()) == null ? undefined : _a2.context;
...
const LazyProseCodeIcon = defineAsyncComponent(() => import('./ProseCodeIcon-BOyS_XyA.mjs').then((r2) => r2["default"] || r2.default || r2));
const LazyProseH1 = defineAsyncComponent(() => import('./ProseH1-Cjof21Ki.mjs').then((r2) => r2["default"] || r2.default || r2));
...
const LazyMarkdown = defineAsyncComponent(() => import('./Markdown-BY4Q_1zw.mjs').then((r2) => r2["default"] || r2.default || r2));
const LazyProseCodeInline = defineAsyncComponent(() => import('./ProseCodeInline-BHp-WEz-.mjs').then((r2) => r2["default"] || r2.default || r2));
const LazyProsePre = defineAsyncComponent(() => import('./ProsePre-BHHkf67M.mjs').then((r2) => r2["default"] || r2.default || r2));
...
const LazyProseStrong = defineAsyncComponent(() => import('./ProseStrong-amtoNI5h.mjs').then((r2) => r2["default"] || r2.default || r2));
const LazyProseTable = defineAsyncComponent(() => import('./ProseTable-BkZbIsUB.mjs').then((r2) => r2["default"] || r2.default || r2));
const LazyProseTbody = defineAsyncComponent(() => import('./ProseTbody-CVSzs5Qd.mjs').then((r2) => r2["default"] || r2.default || r2));
const LazyProseTd = defineAsyncComponent(() => import('./ProseTd-CIaBjqrc.mjs').then((r2) => r2["default"] || r2.default || r2));
const LazyProseTh = defineAsyncComponent(() => import('./ProseTh-DsDyz2tn.mjs').then((r2) => r2["default"] || r2.default || r2));
const LazyProseThead = defineAsyncComponent(() => import('./ProseThead-Cd-xCgZR.mjs').then((r2) => r2["default"] || r2.default || r2));
const LazyProseTr = defineAsyncComponent(() => import('./ProseTr-IeyjNyJQ.mjs').then((r2) => r2["default"] || r2.default || r2));
const LazyProseUl = defineAsyncComponent(() => import('./ProseUl-BN9an5RG.mjs').then((r2) => r2["default"] || r2.default || r2));
...
const robot_meta_server_8htXH4OkuR = /* @__PURE__ */ defineNuxtPlugin({
  setup() {
    ...
    const ctx = (_a2 = event == null ? undefined : event.context) == null ? undefined : _a2.robots;
    if (!ctx)
      return;
    const config2 = /* @__PURE__ */ useRuntimeConfig();
    useServerHead({
      meta: [
        {
          ...
          "data-hint": () => {
            var _a3, _b;
            return ((_a3 = config2["nuxt-robots"]) == null ? undefined : _a3.debug) ? (_b = ctx.debug) == null ? undefined : _b.source : undefined;
          }
        }
      ]
    });
...
function getSlotsChildren(slots) {
  var _a2;
  let children = (_a2 = slots.default) == null ? undefined : _a2.call(slots);
  if (children == null ? undefined : children.length) {
    children = children.flatMap((c2) => {
      ...
      if (typeof c2.type === "symbol") {
        ...
        return (_b = (_a3 = c2.ctx.slots).default) == null ? undefined : _b.call(_a3);
      }
      return c2;
    }).filter(Boolean);
  }
...
const useUI = (key, $ui, $config, $wrapperClass, withAppConfig = false) => {
  ...
  const ui = computed(() => {
    ...
    return mergeConfig(
      (_ui == null ? undefined : _ui.strategy) || ((_a2 = appConfig2.ui) == null ? undefined : _a2.strategy),
...
function E$3(e2 = (undefined).body) {
...
function P(e2, r2, { sorted: t2 = true, relativeTo: l2 = null, skipElements: o2 = [] } = {}) {
  var m2;
  let i2 = (m2 = Array.isArray(e2) ? e2.length > 0 ? e2[0].ownerDocument : undefined : e2 == null ? undefined : e2.ownerDocument) != null ? m2 : undefined, n2 = Array.isArray(e2) ? t2 ? O$2(e2) : e2 : E$3(e2);
...
function y$1({ props: r2, attrs: t2, slots: e2, slot: o2, name: i2 }) {
  var m2, h2;
  let { as: n2, ...l2 } = T$2(r2, ["unmount", "static"]), a2 = (m2 = e2.default) == null ? undefined : m2.call(e2, o2), d2 = {};
  if (o2) {
    let u2 = false, c2 = [];
  ...
  return onMounted(() => i2.value = true), onUnmounted(() => i2.value = false), onMounted(() => {
    watch([n2, r2, l2], (e2, m2) => {
      ...
      f2 && t$4(() => {
        ...
        a2 ? S$1(a2) : P(f2, N$5.First | N$5.NoScroll) === T$3.Error && console.warn("There are no focusable elements inside the <FocusTrap />"), o2.value = (H2 = t2.value) == null ? undefined : H2.activeElement;
      });
...
let A$1 = "DC8F892D-2EBD-447C-A4C8-A03058436FF4", Ye = defineComponent({ name: "Dialog", inheritAttrs: false, props: { as: { type: [Object, String], default: "div" }, static: { type: Boolean, default: false }, unmount: { type: Boolean, default: true }, open: { type: [Boolean, String], default: A$1 }, initialFocus: { type: Object, default: null }, id: { type: String, default: null }, role: { type: String, default: "dialog" } }, emits: { close: (t2) => true }, setup(t2, { emit: i2, attrs: l2, slots: p2, expose: s$12 }) {
  ...
  let c2 = computed(() => u2.value && R2.value ? 0 : 1), k2 = computed(() => c2.value === 0), w2 = computed(() => D.value > 1), N2 = inject(H, null) !== null, [Q2, X] = q(), { resolveContainers: B2, mainTreeNodeRef: K, MainTreeNode: Z2 } = N$2({ portals: Q2, defaultContainers: [computed(() => {
    ...
    var e2, a2, d2;
    return (d2 = Array.from((a2 = (e2 = E$22.value) == null ? undefined : e2.querySelectorAll("body > *")) != null ? a2 : []).find((f2) => f2.id === "headlessui-portal-root" ? false : f2.contains(o$2(K)) && f2 instanceof HTMLElement)) != null ? d2 : null;
  });
  E(le2, te2);
  let ae2 = computed(() => w2.value ? true : k2.value), oe = computed(() => {
    var e2, a2, d2;
    return (d2 = Array.from((a2 = (e2 = E$22.value) == null ? undefined : e2.querySelectorAll("[data-headlessui-portal]")) != null ? a2 : []).find((f2) => f2.contains(o$2(K)) && f2 instanceof HTMLElement)) != null ? d2 : null;
  });
  ...
  return d$2(E$22, ue2, (e2) => {
    ...
    let { open: e2, initialFocus: a2, ...d2 } = t2, f2 = { ...l2, ref: m2, id: n2, role: g2.value, "aria-modal": c2.value === 0 ? true : undefined, "aria-labelledby": M2.value, "aria-describedby": re2.value }, L2 = { open: c2.value === 0 };
...
let ge$2 = defineComponent({ name: "Menu", props: { as: { type: [Object, String], default: "template" } }, setup(o2, { slots: M2, attrs: i2 }) {
  ...
  return () => {
    ...
    return A$3({ ourProps: { id: p$1, ref: r2, role: "menuitem", tabIndex: u2 === true ? undefined : -1, "aria-disabled": u2 === true ? true : undefined, onClick: b2, onFocus: l2, onPointerenter: a2, onMouseenter: a2, onPointermove: n2, onMousemove: n2, onPointerleave: s3, onMouseleave: s3 }, theirProps: { ...i2, ...h2 }, slot: C, attrs: i2, slots: M2, name: "MenuItem" });
  };
} });
...
let ye = defineComponent({ name: "Popover", inheritAttrs: false, props: { as: { type: [Object, String], default: "div" } }, setup(d2, { slots: P2, attrs: s3, expose: h$2 }) {
  ...
  let t2 = ref(1), o2 = ref(null), y2 = ref(null), v2 = ref(null), m2 = ref(null), b2 = computed(() => i$4(f2)), E2 = computed(() => {
    ...
    for (let x2 of (undefined).querySelectorAll("body > *")) if (Number(x2 == null ? undefined : x2.contains(o$2(o2))) ^ Number(x2 == null ? undefined : x2.contains(o$2(m2)))) return true;
  ...
  let S2 = { buttonId: a2.buttonId, panelId: a2.panelId, close() {
    a2.closePopover();
  } }, c2 = ae(), I2 = c2 == null ? undefined : c2.registerPopover, [F2, w2] = q(), i2 = N$2({ mainTreeNodeRef: c2 == null ? undefined : c2.mainTreeNodeRef, portals: F2, defaultContainers: [o2, m2] });
  function p2() {
    var e2, r2, l2, g2;
    return (g2 = c2 == null ? undefined : c2.isFocusWithinPopoverGroup()) != null ? g2 : ((e2 = b2.value) == null ? undefined : e2.activeElement) && (((r2 = o$2(o2)) == null ? undefined : r2.contains(b2.value.activeElement)) || ((l2 = o$2(m2)) == null ? undefined : l2.contains(b2.value.activeElement)));
  }
  return watchEffect(() => I2 == null ? undefined : I2(S2)), E$1((u2 = b2.value) == null ? undefined : u2.defaultView, "focus", (e2) => {
    var r2, l2;
    e2.target !== undefined && e2.target instanceof HTMLElement && t2.value === 0 && (p2() || o2 && m2 && (i2.contains(e2.target) || (r2 = o$2(a2.beforePanelSentinel)) != null && r2.contains(e2.target) || (l2 = o$2(a2.afterPanelSentinel)) != null && l2.contains(e2.target) || a2.closePopover()));
  ...
  let y2 = ae(), v2 = y2 == null ? undefined : y2.closeOthers, m2 = ge$1(), b2 = computed(() => m2 === null ? false : m2.value === t2.panelId.value), E2 = ref(null), a2 = `headlessui-focus-sentinel-${i$6()}`;
  ...
  function c2(e2) {
    ...
    if (b2.value) {
      ...
      case o$1.Enter:
        ...
        break;
      case o$1.Escape:
        if (t2.popoverState.value !== 0) return v2 == null ? undefined : v2(t2.buttonId.value);
  ...
  return () => {
    let e2 = t2.popoverState.value === 0, r2 = { open: e2 }, { ...l2 } = d2, g2 = b2.value ? { ref: E2, type: S2.value, onKeydown: c2, onClick: F2 } : { ref: E2, id: f2, type: S2.value, "aria-expanded": t2.popoverState.value === 0, "aria-controls": o$2(t2.panel) ? t2.panelId.value : undefined, disabled: d2.disabled ? true : undefined, onKeydown: c2, onKeyup: I2, onClick: F2, onMousedown: w2 };
...
let je = defineComponent({ name: "PopoverPanel", props: { as: { type: [Object, String], default: "div" }, static: { type: Boolean, default: false }, unmount: { type: Boolean, default: true }, focus: { type: Boolean, default: false }, id: { type: String, default: null } }, inheritAttrs: false, setup(d2, { attrs: P$1, slots: s3, expose: h2 }) {
  ...
  h2({ el: o2.panel, $el: o2.panel }), onMounted(() => {
    ...
    let i2 = (p2 = y2.value) == null ? undefined : p2.activeElement;
  ...
  function S2(i2) {
    ...
    p2 && o$2(o2.panel) && ((u2 = o$2(o2.panel)) != null && u2.contains(p2) || (o2.closePopover(), ((r2 = (e2 = o$2(o2.beforePanelSentinel)) == null ? undefined : e2.contains) != null && r2.call(e2, p2) || (g2 = (l2 = o$2(o2.afterPanelSentinel)) == null ? undefined : l2.contains) != null && g2.call(l2, p2)) && p2.focus({ preventScroll: true })));
  }
  let c2 = n();
  function I2() {
    let i2 = o$2(o2.panel);
  ...
  return () => {
    let i2 = { open: o2.popoverState.value === 0, close: o2.close }, { focus: p2, ...u2 } = d2, e2 = { ref: o2.panel, id: f2, onKeydown: a2, onFocusout: t2 && o2.popoverState.value === 0 ? S2 : undefined, tabIndex: -1 };
    return A$3({ ourProps: e2, theirProps: { ...P$1, ...u2 }, attrs: P$1, slot: i2, slots: { ...s3, default: (...r2) => {
      var l2;
      return [h$1(Fragment, [E2.value && o2.isPortalled.value && h$1(f$2, { id: v2, ref: o2.beforePanelSentinel, features: u$4.Focusable, "data-headlessui-focus-guard": true, as: "button", type: "button", onFocus: I2 }), (l2 = s3.default) == null ? undefined : l2.call(s3, ...r2), E2.value && o2.isPortalled.value && h$1(f$2, { id: m2, ref: o2.afterPanelSentinel, features: u$4.Focusable, "data-headlessui-focus-guard": true, as: "button", type: "button", onFocus: F2 })])];
...
defineComponent({ name: "PopoverGroup", inheritAttrs: false, props: { as: { type: [Object, String], default: "div" } }, setup(d2, { attrs: P2, slots: s3, expose: h2 }) {
  ...
  function b2() {
    ...
    return (c2 = o$2(f2)) != null && c2.contains(S2) ? true : t2.value.some((I2) => {
      var F2, w2;
      return ((F2 = a2.getElementById(I2.buttonId.value)) == null ? undefined : F2.contains(S2)) || ((w2 = a2.getElementById(I2.panelId.value)) == null ? undefined : w2.contains(S2));
    });
  }
  function E2(a2) {
    ...
    var instance = {
      ...
      forceUpdate: function forceUpdate() {
        ...
        for (var index2 = 0; index2 < state.orderedModifiers.length; index2++) {
          ...
          var _state$orderedModifie = state.orderedModifiers[index2], fn2 = _state$orderedModifie.fn, _state$orderedModifie2 = _state$orderedModifie.options, _options = _state$orderedModifie2 === undefined ? {} : _state$orderedModifie2, name = _state$orderedModifie.name;
...
const _sfc_main$z = defineComponent({
  ...
  setup(props, { emit }) {
    ...
    const containerStyle = computed(() => {
      ...
      const offsetDistance = ((_a2 = props.popper) == null ? undefined : _a2.offsetDistance) || ((_b = ui.value.popper) == null ? undefined : _b.offsetDistance) || 8;
    ...
    watch(() => {
      var _a2;
      return (_a2 = popoverApi.value) == null ? undefined : _a2.popoverState;
    }, (newValue, oldValue) => {
      if (oldValue === undefined || newValue === oldValue) return;
...
_sfc_main$z.setup = (props, ctx) => {
  ...
  return _sfc_setup$z ? _sfc_setup$z(props, ctx) : undefined;
};
...
_sfc_main$x.setup = (props, ctx) => {
  ...
  return _sfc_setup$x ? _sfc_setup$x(props, ctx) : undefined;
};
...
const _sfc_main$w = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if ((_a2 = __props.links) == null ? undefined : _a2.length) {
...
const __nuxt_component_3$2 = Object.assign(_sfc_main$w, { __name: "UHeaderPopoverLinks" });
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if ((_a2 = __props.links) == null ? undefined : _a2.length) {
        ...
        ssrRenderList(__props.links, (link, index2) => {
          ...
          if ((_a3 = link.children) == null ? undefined : _a3.length) {
...
_sfc_main$v.setup = (props, ctx) => {
  ...
  return _sfc_setup$v ? _sfc_setup$v(props, ctx) : undefined;
};
...
function useInjectButtonGroup({ ui, props }) {
  ...
  return {
    size: computed(() => {
      ...
      return (groupContext == null ? undefined : groupContext.value.size) ?? ui.value.default.size;
    }),
    rounded: computed(() => {
...
const _sfc_main$u = defineComponent({
  ...
  setup(props, { slots }) {
    ...
    const buttonClass = computed(() => {
      var _a2, _b;
      const variant = ((_b = (_a2 = ui.value.color) == null ? undefined : _a2[props.color]) == null ? undefined : _b[props.variant]) || ui.value.variant[props.variant];
      return twMerge(twJoin(
        ui.value.base,
        ui.value.font,
        rounded.value,
...
_sfc_main$u.setup = (props, ctx) => {
  ...
  return _sfc_setup$u ? _sfc_setup$u(props, ctx) : undefined;
};
...
_sfc_main$t.setup = (props, ctx) => {
  ...
  return _sfc_setup$t ? _sfc_setup$t(props, ctx) : undefined;
};
          ...
          if (_push2) {
            ...
            ssrRenderSlot(_ctx.$slots, "panel-button", { open: unref(isHeaderDialogOpen) }, () => {
              ...
              if (__props.links.length || _ctx.$slots.panel) {
                ...
                }, (_b = (_a2 = unref($ui)) == null ? undefined : _a2.button) == null ? undefined : _b.secondary, {
...
function _sfc_ssrRender$e(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  ...
  if (_ctx.open && !_ctx.prevent && _ctx.isVisible) {
    ...
    if ((_a2 = _ctx.shortcuts) == null ? undefined : _a2.length) {
...
const _sfc_main$m = /* @__PURE__ */ defineComponent({
  ...
  async setup(__props, { emit: __emit }) {
    ...
    function fixActionRestriction() {
      (undefined).body.classList.remove(
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      const _component_UDashboardSidebarLinks = __nuxt_component_3$1;
            ...
            ssrRenderList(__props.links, (link, index2) => {
              ssrRenderVNode(_push2, createVNode(resolveDynamicComponent(__props.draggable && unref(Draggable) ? unref(Draggable) : "li"), {
                ...
                default: withCtx((_22, _push3, _parent3, _scopeId2) => {
                  var _a2, _b;
                  if (_push3) {
                    ssrRenderVNode(_push3, createVNode(resolveDynamicComponent(((_a2 = link.children) == null ? undefined : _a2.length) ? unref(N$1) : "div"), {
                      ...
                      default: withCtx((slotProps, _push4, _parent4, _scopeId3) => {
                        var _a3, _b2, _c;
                        if (_push4) {
                          ssrRenderVNode(_push4, createVNode(resolveDynamicComponent(((_a3 = link.children) == null ? undefined : _a3.length) ? unref(Q$1) : "div"), { as: "template" }, {
                              ...
                              if (_push5) {
                                _push5(ssrRenderComponent(_component_UTooltip, mergeProps({
                                  ...
                                  default: withCtx((_4, _push6, _parent6, _scopeId5) => {
                                    var _a4, _b3, _c2, _d;
                                    if (_push6) {
                                      _push6(ssrRenderComponent(_component_ULink, mergeProps({ ref_for: true }, ((_a4 = link.children) == null ? undefined : _a4.length) && link.collapsible !== false ? { disabled: link.disabled } : unref(getULinkProps)(link), {
                                        class: [unref(ui).base, unref(isDragging) && "pointer-events-none"],
                                        "active-class": unref(ui).active,
                                        "inactive-class": !link.to && link.collapsible === false && __props.level === 0 && ((_b3 = link.children) == null ? undefined : _b3.length) ? unref(ui).static : unref(ui).inactive,
                                        draggable: "false",
                                        onClick: link.click
                                      }), {
                                        default: withCtx(({ isActive }, _push7, _parent7, _scopeId6) => {
                                          ...
                                          if (_push7) {
                                            ssrRenderSlot(_ctx.$slots, "icon", {
                                              ...
                                              if (link.icon) {
                                                _push7(ssrRenderComponent(_component_UIcon, {
                                                  name: link.icon,
                                                  class: unref(twMerge$1)(unref(twJoin)(unref(ui).icon.base, isActive ? unref(ui).icon.active : !link.to && link.collapsible === false && __props.level === 0 && ((_a6 = link.children) == null ? undefined : _a6.length) ? unref(ui).static : unref(ui).icon.inactive), link.iconClass)
                                            ...
                                            if (((_a5 = link.children) == null ? undefined : _a5.length) && link.collapsible !== false) {
                                              _push7(ssrRenderComponent(_component_UIcon, {
                                                name: unref(ui).trailingIcon.name,
                                                class: [unref(ui).trailingIcon.base, (slotProps == null ? undefined : slotProps.open) ? unref(ui).trailingIcon.active : unref(ui).trailingIcon.inactive]
                                              }, null, _parent7, _scopeId6));
                                            } else {
                                              _push7(`<!---->`);
                                            }
                                            ...
                                            return [
                                              ...
                                              ((_b4 = link.children) == null ? undefined : _b4.length) && link.collapsible !== false ? (openBlock(), createBlock(_component_UIcon, {
                                                key: 0,
                                                name: unref(ui).trailingIcon.name,
                                                class: [unref(ui).trailingIcon.base, (slotProps == null ? undefined : slotProps.open) ? unref(ui).trailingIcon.active : unref(ui).trailingIcon.inactive]
                                              }, null, 8, ["name", "class"])) : createCommentVNode("", true),
                                      ...
                                      return [
                                        createVNode(_component_ULink, mergeProps({ ref_for: true }, ((_c2 = link.children) == null ? undefined : _c2.length) && link.collapsible !== false ? { disabled: link.disabled } : unref(getULinkProps)(link), {
                                          class: [unref(ui).base, unref(isDragging) && "pointer-events-none"],
                                          "active-class": unref(ui).active,
                                          "inactive-class": !link.to && link.collapsible === false && __props.level === 0 && ((_d = link.children) == null ? undefined : _d.length) ? unref(ui).static : unref(ui).inactive,
                                          draggable: "false",
                                          onClick: link.click
                                        }), {
                                          default: withCtx(({ isActive }) => {
                                            ...
                                            return [
                                              ...
                                              ((_a5 = link.children) == null ? undefined : _a5.length) && link.collapsible !== false ? (openBlock(), createBlock(_component_UIcon, {
                                                key: 0,
                                                name: unref(ui).trailingIcon.name,
                                                class: [unref(ui).trailingIcon.base, (slotProps == null ? undefined : slotProps.open) ? unref(ui).trailingIcon.active : unref(ui).trailingIcon.inactive]
                                              }, null, 8, ["name", "class"])) : createCommentVNode("", true),
                                ...
                                return [
                                  createVNode(_component_UTooltip, mergeProps({
                                    ...
                                    default: withCtx(() => {
                                      var _a4, _b3;
                                      return [
                                        createVNode(_component_ULink, mergeProps({ ref_for: true }, ((_a4 = link.children) == null ? undefined : _a4.length) && link.collapsible !== false ? { disabled: link.disabled } : unref(getULinkProps)(link), {
                                          class: [unref(ui).base, unref(isDragging) && "pointer-events-none"],
                                          "active-class": unref(ui).active,
                                          "inactive-class": !link.to && link.collapsible === false && __props.level === 0 && ((_b3 = link.children) == null ? undefined : _b3.length) ? unref(ui).static : unref(ui).inactive,
                                          draggable: "false",
                          ...
                          _push4(``);
                          if (((_b2 = link.children) == null ? undefined : _b2.length) && ((slotProps == null ? undefined : slotProps.open) || link.collapsible === false)) {
                          ...
                          return [
                            (openBlock(), createBlock(resolveDynamicComponent(((_c = link.children) == null ? undefined : _c.length) ? unref(Q$1) : "div"), { as: "template" }, {
                              default: withCtx(() => [
                                createVNode(_component_UTooltip, mergeProps({
                                  class: "flex",
                                  popper: { placement: "right" },
                            ...
                            createVNode(Transition, mergeProps({ ref_for: true }, unref(ui).transition, {
                              ...
                              default: withCtx(() => {
                                var _a4;
                                return [
                                  ((_a4 = link.children) == null ? undefined : _a4.length) && ((slotProps == null ? undefined : slotProps.open) || link.collapsible === false) ? (openBlock(), createBlock(unref(V), {
                                    key: 0,
                                    static: "",
                                    as: "template"
                                  }, {
                    ...
                    return [
                      (openBlock(), createBlock(resolveDynamicComponent(((_b = link.children) == null ? undefined : _b.length) ? unref(N$1) : "div"), {
                        "default-open": link.defaultOpen === undefined ? true : link.defaultOpen,
                        as: "div"
                      }, {
                        default: withCtx((slotProps) => {
                          var _a3;
                          return [
                            (openBlock(), createBlock(resolveDynamicComponent(((_a3 = link.children) == null ? undefined : _a3.length) ? unref(Q$1) : "div"), { as: "template" }, {
                              default: withCtx(() => [
                                createVNode(_component_UTooltip, mergeProps({
                                  class: "flex",
                                  popper: { placement: "right" },
                                  ...
                                  default: withCtx(() => {
                                    ...
                                    return [
                                      createVNode(_component_ULink, mergeProps({ ref_for: true }, ((_a4 = link.children) == null ? undefined : _a4.length) && link.collapsible !== false ? { disabled: link.disabled } : unref(getULinkProps)(link), {
                                        class: [unref(ui).base, unref(isDragging) && "pointer-events-none"],
                                        "active-class": unref(ui).active,
                                        "inactive-class": !link.to && link.collapsible === false && __props.level === 0 && ((_b2 = link.children) == null ? undefined : _b2.length) ? unref(ui).static : unref(ui).inactive,
                                        draggable: "false",
                                        onClick: link.click
                                      }), {
                                        default: withCtx(({ isActive }) => {
              ...
              (openBlock(true), createBlock(Fragment, null, renderList(__props.links, (link, index2) => {
                return openBlock(), createBlock(resolveDynamicComponent(__props.draggable && unref(Draggable) ? unref(Draggable) : "li"), {
                  ...
                  default: withCtx(() => {
                    var _a2;
                    return [
                      (openBlock(), createBlock(resolveDynamicComponent(((_a2 = link.children) == null ? undefined : _a2.length) ? unref(N$1) : "div"), {
                        "default-open": link.defaultOpen === undefined ? true : link.defaultOpen,
                        as: "div"
                      }, {
                        default: withCtx((slotProps) => {
                                  ...
                                  default: withCtx(() => {
                                    ...
                                    return [
                                      createVNode(_component_ULink, mergeProps({ ref_for: true }, ((_a4 = link.children) == null ? undefined : _a4.length) && link.collapsible !== false ? { disabled: link.disabled } : unref(getULinkProps)(link), {
                                        class: [unref(ui).base, unref(isDragging) && "pointer-events-none"],
                                        "active-class": unref(ui).active,
                                        "inactive-class": !link.to && link.collapsible === false && __props.level === 0 && ((_b = link.children) == null ? undefined : _b.length) ? unref(ui).static : unref(ui).inactive,
                                        draggable: "false",
                                        onClick: link.click
                                      }), {
                                        default: withCtx(({ isActive }) => {
...
const __nuxt_component_3$1 = Object.assign(_sfc_main$m, { __name: "UDashboardSidebarLinks" });
...
const _sfc_main$k = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    const links = computed(() => [{
      ...
      children: [{
        label: "Webspaces",
        to: "/products/webspace",
        icon: "i-heroicons-cloud",
        description: "Leistungsstarke Webhosting-Pakete."
      }, {
        label: "Domains",
        to: "/products/domain",
        icon: "i-heroicons-at-symbol",
        description: "Sichere dir deine Wunschdomain."
      }, {
        label: "VPS & Root-Server",
        to: "/products/vps-root",
        icon: "i-heroicons-server",
        description: "Flexibel skalierbare Server für kleine/mittlere Projekte."
      }, {
        label: "Dedizierte Server",
        to: "/products/dedicated",
        icon: "i-heroicons-server-stack",
        description: "Dedizierte Server ohne Ressourcen-Sharing."
      }, {
        label: "Lizenzen & Zertifikate",
        to: "/products/lic-cert",
        icon: "i-heroicons-key",
        description: "Plesk, cPanel & SSL/TLS Zertifikate."
      }]
    }, {
      label: "Newsroom",
      to: "/newsroom",
            ...
            vnode = h$1(Suspense, {
              ...
              default: () => {
                const providerVNode = h$1(RouteProvider, {
                  key: key || undefined,
                  vnode: slots.default ? h$1(Fragment, undefined, slots.default(routeProps)) : routeProps.Component,
...
function hasChildrenRoutes(fork, newRoute, Component) {
  ...
  const index2 = newRoute.matched.findIndex((m2) => {
    var _a2;
    return ((_a2 = m2.components) == null ? undefined : _a2.default) === (Component == null ? undefined : Component.type);
  });
...
const _sfc_main$g = defineComponent({
  ...
  setup(props, { emit }) {
    ...
    watch(() => {
      var _a2;
      return (_a2 = menuApi.value) == null ? undefined : _a2.menuState;
    }, (newValue, oldValue) => {
      if (oldValue === undefined || newValue === oldValue) return;
      emit("update:open", newValue === 0);
    });
                                  ...
                                  default: withCtx((_3, _push6, _parent6, _scopeId5) => {
                                    if (_push6) {
                                      ssrRenderSlot(_ctx.$slots, item.slot || "item", { item }, () => {
                                        ...
                                        if ((_a2 = item.shortcuts) == null ? undefined : _a2.length) {
                                      ...
                                      return [
                                        renderSlot(_ctx.$slots, item.slot || "item", { item }, () => {
                                          ...
                                          return [
                                            ...
                                            ((_a2 = item.shortcuts) == null ? undefined : _a2.length) ? (openBlock(), createBlock("span", {
                                              key: 2,
...
const useFormGroup = (inputProps, config2, bind = true) => {
  ...
  function emitFormBlur() {
    emitFormEvent("blur", formGroup2 == null ? undefined : formGroup2.name.value);
    blurred.value = true;
  }
  function emitFormChange() {
    emitFormEvent("change", formGroup2 == null ? undefined : formGroup2.name.value);
  }
  const emitFormInput = useDebounceFn(() => {
    if (blurred.value || (formGroup2 == null ? undefined : formGroup2.eagerValidation.value)) {
      emitFormEvent("input", formGroup2 == null ? undefined : formGroup2.name.value);
    }
  }, 300);
  return {
    inputId: computed(() => (inputProps == null ? undefined : inputProps.id) ?? (formGroup2 == null ? undefined : formGroup2.inputId.value)),
    name: computed(() => (inputProps == null ? undefined : inputProps.name) ?? (formGroup2 == null ? undefined : formGroup2.name.value)),
    size: computed(() => {
      var _a2;
      const formGroupSize = config2.size[formGroup2 == null ? undefined : formGroup2.size.value] ? formGroup2 == null ? undefined : formGroup2.size.value : null;
      return (inputProps == null ? undefined : inputProps.size) ?? formGroupSize ?? ((_a2 = config2.default) == null ? undefined : _a2.size);
    }),
    color: computed(() => {
      var _a2;
      return ((_a2 = formGroup2 == null ? undefined : formGroup2.error) == null ? undefined : _a2.value) ? "red" : inputProps == null ? undefined : inputProps.color;
    }),
    emitFormBlur,
    emitFormInput,
    emitFormChange
...
const _sfc_main$c = defineComponent({
  ...
  setup(props, { emit, slots }) {
    ...
    const inputClass = computed(() => {
      var _a2, _b;
      const variant = ((_b = (_a2 = ui.value.color) == null ? undefined : _a2[color.value]) == null ? undefined : _b[props.variant]) || ui.value.variant[props.variant];
      return twMerge(twJoin(
        ui.value.base,
        ui.value.form,
        rounded.value,
...
const _sfc_main$7 = defineComponent({
  ...
  setup(props) {
    ...
    const error = computed(() => {
      var _a2, _b;
      return props.error && typeof props.error === "string" || typeof props.error === "boolean" ? props.error : (_b = (_a2 = formErrors == null ? undefined : formErrors.value) == null ? undefined : _a2.find((error2) => error2.path === props.name)) == null ? undefined : _b.message;
    });
...
const _sfc_main$6 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (!((_a2 = unref(colorMode)) == null ? undefined : _a2.forced)) {
              ...
              right: withCtx((_22, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  ...
                  _push3(ssrRenderComponent(_component_UFormGroup, {
                    label: "Verpasse keine Neuigkeiten mehr!",
                    ui: { container: "mt-3" },
...
const _sfc_main$4 = defineComponent({
  ...
  setup(props, { emit }) {
    ...
    const wrapperClass = computed(() => {
      ...
      return twMerge(twJoin(
        ui.value.wrapper,
        (_a2 = ui.value.background) == null ? undefined : _a2.replaceAll("{color}", props.color),
        ui.value.rounded,
        ui.value.shadow,
        (_b = ui.value.ring) == null ? undefined : _b.replaceAll("{color}", props.color)
      ), props.class);
    });
    const progressClass = computed(() => {
      ...
      return twJoin(
        ...
        (_a2 = ui.value.progress.background) == null ? undefined : _a2.replaceAll("{color}", props.color)
      );
    });
    ...
    const iconClass = computed(() => {
      ...
      return twJoin(
        ui.value.icon.base,
        (_a2 = ui.value.icon.color) == null ? undefined : _a2.replaceAll("{color}", props.color)
      );
    });
        ...
        _push(ssrRenderComponent(_component_UBadge, {
          ...
          default: withCtx((_2, _push2, _parent2, _scopeId) => {
            if (_push2) {
              ...
              return [
                createTextVNode(toDisplayString(unref(cart).totalItems > 9 ? "9+" : unref(cart).totalItems), 1)
              ];
            }
          }),
          _: 1
