...
import { ak as useState, a6 as useAsyncData, af as useRuntimeConfig, X as __nuxt_component_0$e } from './server.mjs';
import { u as useContentDisabled, q as queryContent, w as withContentBase, e as encodeQueryParams, a as addPrerenderPath, s as shouldUseClientDB, j as jsonStringify } from './query-BPOdX6Mi.mjs';
import { u as useContentPreview } from './preview-CO4qsbxF.mjs';
...
const fetchContentNavigation = async (queryBuilder) => {
  ...
  if (shouldUseClientDB()) {
    const generateNavigation = await import('./client-db-BQrnEyHU.mjs').then((m) => m.generateNavigation);
...
//# sourceMappingURL=ContentNavigation-CooGm8sV.mjs.map
