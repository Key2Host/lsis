    ...
    const faqItems = [
      {
        ...
        "content": "Wir legen großen Wert auf Sicherheit. Alle Registrierungen werden manuell überprüft, um Spam und Betrug zu vermeiden. Zudem setzen wir auf moderne Verschlüsselungstechnologien, DDoS-Schutz und regelmäßige Sicherheitsupdates.",
        "defaultOpen": true
      },
      {
        "label": "Wie lange dauert die Freischaltung meines Accounts?",
        "content": "Da jede Registrierung manuell überprüft wird, kann die Freischaltung je nach Aufkommen bis zu 24 Stunden dauern. Dies gewährleistet ein sicheres und professionelles Umfeld für unsere Kunden."
      },
      {
    ...
    async function postContact(event) {
      ...
      try {
        const response = await axios.post(
          "http://localhost:80/api/public/contact/",
          {
...
//# sourceMappingURL=contact-C1yLmtPL.mjs.map
