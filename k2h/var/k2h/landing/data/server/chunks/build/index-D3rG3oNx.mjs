...
import { useSSRContext, defineComponent, withAsyncContext, mergeProps, withCtx, openBlock, createBlock, Fragment, renderList, createVNode, computed, toRef, unref } from 'vue';
import { ssrRenderComponent, ssrRenderList, ssrRenderAttrs, ssrRenderSlot } from 'vue/server-renderer';
import { a6 as useAsyncData, u as useSeoMeta, F as useUI } from './server.mjs';
import { _ as __nuxt_component_2 } from './BlogPost-Cktj775C.mjs';
import { q as queryContent } from './query-BPOdX6Mi.mjs';
...
import './NuxtImg-Dc358xqn.mjs';
import './preview-CO4qsbxF.mjs';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  async setup(__props) {
    ...
    [__temp, __restore] = withAsyncContext(() => useAsyncData("index", () => queryContent("/newsroom").findOne())), __temp = await __temp, __restore();
    useSeoMeta({
      title: "Newsroom",
      ogTitle: "Newsroom",
      description: "",
...
//# sourceMappingURL=index-D3rG3oNx.mjs.map
