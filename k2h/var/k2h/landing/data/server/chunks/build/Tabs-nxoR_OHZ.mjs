import { F as useUI, C as __nuxt_component_1$3 } from './server.mjs';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    const tabs = computed(() => {
      var _a;
      return ((_a = slots.default) == null ? undefined : _a.call(slots).map((slot, index) => {
        var _a2, _b;
        return {
          index,
          label: ((_a2 = slot.props) == null ? undefined : _a2.label) || `${index}`,
          icon: (_b = slot.props) == null ? undefined : _b.icon,
          component: slot
        };
      })) || [];
    });
...
//# sourceMappingURL=Tabs-nxoR_OHZ.mjs.map
