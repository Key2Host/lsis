import { Y as useAppConfig, F as useUI, a3 as __nuxt_component_0$d, C as __nuxt_component_1$3, P as __nuxt_component_0$9 } from './server.mjs';
import { useSSRContext, defineComponent, computed, toRef, mergeProps, unref, withCtx, openBlock, createBlock, renderSlot, createVNode, createTextVNode, toDisplayString, createCommentVNode, Fragment, renderList } from 'vue';
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_component_UContainer, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          ...
          if (_push2) {
            if (__props.icon || _ctx.$slots.icon || (__props.headline || _ctx.$slots.headline) || (__props.title || _ctx.$slots.title) || (__props.description || _ctx.$slots.description) || (((_a = __props.links) == null ? undefined : _a.length) || _ctx.$slots.links)) {
              ...
              if (__props.align !== "center" && ((_b = __props.features) == null ? undefined : _b.length)) {
              ...
              if (__props.align !== "center" && (((_c = __props.links) == null ? undefined : _c.length) || _ctx.$slots.links)) {
            ...
            if (__props.align === "center" && ((_d = __props.features) == null ? undefined : _d.length)) {
            ...
            if (__props.align === "center" && (((_e = __props.links) == null ? undefined : _e.length) || _ctx.$slots.links)) {
            ...
            return [
              __props.icon || _ctx.$slots.icon || (__props.headline || _ctx.$slots.headline) || (__props.title || _ctx.$slots.title) || (__props.description || _ctx.$slots.description) || (((_f = __props.links) == null ? undefined : _f.length) || _ctx.$slots.links) ? (openBlock(), createBlock("div", {
                key: 0,
                class: unref(ui).base
              }, [
                ...
                __props.align !== "center" && ((_g = __props.features) == null ? undefined : _g.length) ? (openBlock(), createBlock("dl", {
                  key: 4,
                ...
                __props.align !== "center" && (((_h = __props.links) == null ? undefined : _h.length) || _ctx.$slots.links) ? (openBlock(), createBlock("div", {
                  key: 5,
              ...
              __props.align === "center" && ((_i = __props.features) == null ? undefined : _i.length) ? (openBlock(), createBlock("dl", {
                key: 3,
              ...
              __props.align === "center" && (((_j = __props.links) == null ? undefined : _j.length) || _ctx.$slots.links) ? (openBlock(), createBlock("div", {
                key: 4,
...
const __nuxt_component_0 = Object.assign(_sfc_main, { __name: "ULandingSection" });

export { __nuxt_component_0 as _ };
//# sourceMappingURL=LandingSection-bJhjn_Li.mjs.map
