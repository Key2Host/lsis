import { _ as _sfc_main$1 } from './PageCTA-BljcmuD9.mjs';
import { _ as _sfc_main$2 } from './PageBody-DQTQFfQj.mjs';
import { j as useCookieNoticeStore, d as useSeoMeta, l as _sfc_main$l } from './server.mjs';
          ...
          if (_push2) {
            ...
            return [
              ...
              createVNode("div", { class: "mb-6" }, [
                ...
                createVNode("div", { class: "overflow-auto max-w-[85vw]" }, [
                  createVNode("table", { class: "ml-8 border text-sm text-left" }, [
                    createVNode("thead", { class: "bg-primary-400" }, [
                      createVNode("tr", null, [
                        createVNode("th", { class: "px-4 py-2 border-b text-white" }, "Cookie/Technologie"),
                        createVNode("th", { class: "px-4 py-2 border-b text-white" }, "Zweck"),
                        createVNode("th", { class: "px-4 py-2 border-b text-white" }, "Speicherdauer"),
                        createVNode("th", { class: "px-4 py-2 border-b text-white" }, "Anbieter / Empfänger"),
                        createVNode("th", { class: "px-4 py-2 border-b text-white" }, "Rechtsgrundlage")
                      ])
                    ]),
                    createVNode("tbody", null, [
                      createVNode("tr", { class: "hover:bg-primary-200 hover:text-black" }, [
...
//# sourceMappingURL=privacy-DYO_nYbd.mjs.map
