...
import { u as useAppConfig, n as tv$1 } from './server.mjs';
...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    const ui = computed(() => {
      var _a;
      return tv$1({ extend: tv$1(theme), ...((_a = appConfig.ui) == null ? void 0 : _a.skeleton) || {} });
    });
...
//# sourceMappingURL=Skeleton-CNUiTn1T.mjs.map
