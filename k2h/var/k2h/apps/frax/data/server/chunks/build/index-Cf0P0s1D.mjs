import { M as Motion, _ as _sfc_main$6 } from './PageSection-Bp1Prz50.mjs';
import { defineComponent, ref, withAsyncContext, computed, withCtx, unref, createVNode, mergeProps, createBlock, openBlock, Fragment, renderList, renderSlot, useSlots, resolveDynamicComponent, createCommentVNode, toDisplayString, createTextVNode, provide, useSSRContext } from 'vue';
...
import { b as useI18n, U as useAsyncData, d as useSeoMeta, u as useAppConfig, t as tv, m as useLocale, S as getSlotChildrenText, T as ImageComponent, R as _sfc_main$v, e as _sfc_main$o, E as _sfc_main$x, r as reactivePick, n as tv$1, k as _sfc_main$u, Q as avatarGroupInjectionKey } from './server.mjs';
import { q as queryCollection } from './app-CXXWM6cm.mjs';
...
import { _ as _sfc_main$7 } from './Chip-BqYVcE-F.mjs';
import 'hey-listen';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  async setup(__props) {
    ...
    const { data: posts } = ([__temp, __restore] = withAsyncContext(() => useAsyncData(
      "news",
      () => queryCollection("newsroom").all().then(
        (posts2) => posts2.sort((a, b) => new Date(b.date).getTime() - new Date(a.date).getTime())
      )
            ...
            if (_push2) {
              ...
              ssrRenderList(paginatedPosts.value, (post, index) => {
                _push2(ssrRenderComponent(_component_Motion, {
                  ...
                  default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                    if (_push3) {
                      _push3(ssrRenderComponent(unref(_sfc_main$3), mergeProps({
                        to: post.path,
                        ref_for: true
...
//# sourceMappingURL=index-Cf0P0s1D.mjs.map
