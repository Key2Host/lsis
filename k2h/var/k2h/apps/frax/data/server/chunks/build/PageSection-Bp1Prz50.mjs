import { useSlots, computed, unref, mergeProps, withCtx, createBlock, createCommentVNode, renderSlot, openBlock, createTextVNode, toDisplayString, Fragment, renderList, createVNode, defineComponent, h, ref, useAttrs, getCurrentInstance, Comment, cloneVNode, inject, provide, watch, useSSRContext } from 'vue';
import { invariant as invariant$1 } from 'hey-listen';
import { u as useAppConfig, t as tv, W as _sfc_main$t, _ as _sfc_main$z, k as _sfc_main$u, S as getSlotChildrenText, R as _sfc_main$v } from './server.mjs';
...
function convertSvgStyleToAttributes(keyframes2) {
  ...
  for (const key in keyframes2) {
    ...
    if (kebabKey in SVG_STYLE_TO_ATTRIBUTES) {
      ...
      attributes[kebabKey] = isMotionValue$1(value) ? value.get() : value;
    } else {
      styleProps[key] = keyframes2[key];
    }
  }
  if (attributes["path-length"] !== void 0) {
    buildSVGPath$1(attributes, attributes["path-length"], attributes["path-spacing"], attributes["path-offset"]);
  }
  return {
    attributes,
    style: styleProps
...
function press(targetOrSelector, onPressStart, options = {}) {
  ...
  targets.forEach((target) => {
    target = options.useGlobalTarget ? void 0 : target;
...
//# sourceMappingURL=PageSection-Bp1Prz50.mjs.map
