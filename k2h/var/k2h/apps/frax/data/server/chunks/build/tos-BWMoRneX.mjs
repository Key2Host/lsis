import { _ as _sfc_main$2 } from './PageCTA-BljcmuD9.mjs';
import { defineComponent, unref, withCtx, createVNode, computed, mergeProps, renderSlot, useSSRContext } from 'vue';
import { ssrRenderComponent, ssrRenderSlot } from 'vue/server-renderer';
import { Primitive } from 'reka-ui';
import { b as useI18n, d as useSeoMeta, u as useAppConfig, t as tv } from './server.mjs';
import { _ as _sfc_main$3 } from './PageCard-BRo-hvzK.mjs';
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const ui = computed(() => {
      var _a;
      return tv({ extend: tv(theme), ...((_a = appConfig.uiPro) == null ? void 0 : _a.pageColumns) || {} });
    });
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      const _component_UPageColumns = _sfc_main$1;
...
//# sourceMappingURL=tos-BWMoRneX.mjs.map
