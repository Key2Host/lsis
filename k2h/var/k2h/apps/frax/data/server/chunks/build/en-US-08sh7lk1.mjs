const resource = {
  ...
  "index": {
    ...
    "partners": {
      "title": { "t": 0, "b": { "t": 2, "i": [{ "t": 3 }], "s": "The technologies, we use" } }
    },
    "features": {
  ...
  "captcha": {
    "failed": {
      "title": { "t": 0, "b": { "t": 2, "i": [{ "t": 3 }], "s": "CAPTCHA Issue" } },
      "description": { "t": 0, "b": { "t": 2, "i": [{ "t": 3 }], "s": "The CAPTCHA was rejected. Please try again later." } }
    },
    "error": {
      "title": { "t": 0, "b": { "t": 2, "i": [{ "t": 3 }], "s": "CAPTCHA Error" } },
      "description": { "t": 0, "b": { "t": 2, "i": [{ "t": 3 }], "s": "The CAPTCHA could not be verified. Please try again later." } }
    }
  }
};

export { resource as default };
//# sourceMappingURL=en-US-08sh7lk1.mjs.map
