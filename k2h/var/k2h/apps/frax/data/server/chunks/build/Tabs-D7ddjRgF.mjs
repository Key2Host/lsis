...
import { u as useAppConfig, t as tv, h as transformUI, r as reactivePick, n as tv$1, _ as _sfc_main$z, F as _sfc_main$x, D as get } from './server.mjs';
...
const _sfc_main$1 = {
  ...
  setup(__props, { emit: __emit }) {
    ...
    const ui = computed(() => {
      var _a;
      return tv$1({ extend: tv$1(theme$1), ...((_a = appConfig.ui) == null ? void 0 : _a.tabs) || {} })({
        color: props.color,
...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    const ui = computed(() => {
      var _a, _b;
      return tv({ extend: tv(theme), ...((_b = (_a = appConfig.uiPro) == null ? void 0 : _a.prose) == null ? void 0 : _b.tabs) || {} });
    });
...
//# sourceMappingURL=Tabs-D7ddjRgF.mjs.map
