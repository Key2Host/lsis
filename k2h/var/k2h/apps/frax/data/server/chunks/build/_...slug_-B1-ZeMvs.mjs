import { _ as _sfc_main$5, M as Motion } from './PageSection-Bp1Prz50.mjs';
import { defineComponent, withAsyncContext, unref, withCtx, createVNode, toDisplayString, createBlock, createCommentVNode, openBlock, useSlots, computed, mergeProps, renderSlot, createTextVNode, Fragment, renderList, toRaw, resolveComponent, defineAsyncComponent, h, getCurrentInstance, reactive, watch, Text, Comment, useSSRContext } from 'vue';
...
import { a as useLocalePath, Z as useRoute, U as useAsyncData, $ as createError, d as useSeoMeta, m as useLocale, u as useAppConfig, n as tv$1, R as _sfc_main$v, X as pickLinkProps, Y as _sfc_main$w, _ as _sfc_main$z, E as _sfc_main$x, C as get$1, A as createReusableTemplate, t as tv, M as useRuntimeConfig } from './server.mjs';
...
import { q as queryCollection, a as queryCollectionItemSurroundings } from './app-CXXWM6cm.mjs';
import 'hey-listen';
import 'pinia';
import 'vue-router';
...
const __nuxt_component_4 = Object.assign(_sfc_main$2, { __name: "ContentRenderer" });
const theme = {
  "slots": {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (unref(page)) {
        _push(ssrRenderComponent(_component_UPageSection, _attrs, {
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              _push2(`<div class="flex flex-col items-center text-center space-y-6"${_scopeId}>`);
              _push2(ssrRenderComponent(_component_Motion, {
                ...
                default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                  if (_push3) {
                    _push3(`<h1 class="text-4xl md:text-5xl font-extrabold tracking-tight leading-tight text-gray-900 dark:text-white"${_scopeId2}>${ssrInterpolate(unref(page).title)}</h1>`);
                  } else {
                    return [
              ...
              _push2(ssrRenderComponent(_component_Motion, {
                ...
                default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                  if (_push3) {
                    _push3(`<div class="opacity-70"${_scopeId2}>`);
                    _push3(ssrRenderComponent(_component_UBreadcrumb, { items: links }, null, _parent3, _scopeId2));
                    _push3(`</div>`);
                  } else {
                    return [
              ...
              _push2(ssrRenderComponent(_component_Motion, {
                ...
                default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                  if (_push3) {
                    _push3(`<div class="w-full max-w-5xl"${_scopeId2}><img${ssrRenderAttr("src", unref(page).image)}${ssrRenderAttr("alt", unref(page).title)} class="rounded-3xl w-full h-auto shadow-xl ring-1 ring-gray-300/30 dark:ring-white/10 transition-transform duration-300 hover:scale-[1.02]"${_scopeId2}></div>`);
                  } else {
                    return [
                  ...
                  if (_push3) {
                    ...
                    _push3(ssrRenderComponent(_component_Motion, {
                      ...
                      default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                        if (_push4) {
                          if (unref(page).date) {
                            _push4(`<div class="text-center text-sm text-gray-500 italic"${_scopeId3}>${ssrInterpolate(_ctx.$t("newsroom.published") + " " + formatDate(unref(page).date))}</div>`);
                          } else {
                            _push4(`<!---->`);
                          }
                        } else {
...
//# sourceMappingURL=_...slug_-B1-ZeMvs.mjs.map
