...
import { b as useI18n, a2 as useRouter, d as useSeoMeta, k as _sfc_main$u, a3 as _sfc_main$r } from './server.mjs';
import { _ as _sfc_main$2 } from './PageCard-BAQPfmtU.mjs';
import { _ as _sfc_main$3 } from './Tooltip-DGsOnARl.mjs';
          ...
          if (_push2) {
            _push2(ssrRenderComponent(_component_UPageSection, {
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<div class="w-full flex flex-col items-center justify-center mt-6"${_scopeId2}><div class="w-full max-w-2xl flex"${_scopeId2}><input type="text"${ssrRenderAttr("value", domain.value)}${ssrRenderAttr("placeholder", _ctx.$t("products.domain.searchPlaceholder"))} class="w-full p-4 text-lg border border-gray-300 rounded-l-2xl shadow-md focus:outline-none focus:ring-2 focus:ring-blue-500"${_scopeId2}>`);
      ...
      if (searchQuery.value && results.value.length > 0) {
        ...
        ssrRenderList(results.value, (result) => {
          _push(ssrRenderComponent(_component_Motion, {
            ...
            class: "w-full flex flex-wrap justify-center gap-4 max-md:max-w-[350px] max-w-[90%] mx-auto mb-4"
          }, {
            default: withCtx((_, _push2, _parent2, _scopeId) => {
              if (_push2) {
                _push2(ssrRenderComponent(_component_UPageCard, {
                  ...
                  description: withCtx((_2, _push3, _parent3, _scopeId2) => {
                    if (_push3) {
                      _push3(` Die Domain ${ssrInterpolate(searchQuery.value.split(".")[0] + "." + result.name.toLowerCase())} kostet `);
                      _push3(ssrRenderComponent(_component_UTooltip, {
                        ...
                        default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                          if (_push4) {
                            _push4(`<span class="underline decoration-dotted decoration-1 decoration-black/75 dark:decoration-white/75 underline-offset-2 cursor-help"${_scopeId3}>${ssrInterpolate(result.amount + " €")}</span>`);
                          } else {
                            return [
                  ...
                  default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                    if (_push3) {
                      _push3(ssrRenderComponent(_component_UButton, {
                        ...
                        default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                          if (_push4) {
                            _push4(`${ssrInterpolate(result.available ? _ctx.$t("products.domain.addBasket") : _ctx.$t("products.domain.transfer.title"))}`);
                          } else {
                            return [
...
//# sourceMappingURL=index-CH0n1T1q.mjs.map
