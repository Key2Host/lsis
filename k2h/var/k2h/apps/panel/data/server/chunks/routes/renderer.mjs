...
import { b as buildAssetsURL, u as useRuntimeConfig, g as getResponseStatusText, a as getResponseStatus, c as defineRenderHandler, p as publicAssetsURL, f as getQuery, h as createError, i as getRouteRules, j as useNitroApp } from '../nitro/nitro.mjs';
...
const getServerEntry = () => import('../build/server.mjs').then(function (n) { return n.F; }).then((r) => r.default || r);
