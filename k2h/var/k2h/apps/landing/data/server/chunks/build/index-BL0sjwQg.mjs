...
import { a2 as useHead, u as useSeoMeta, x as __nuxt_component_1$3, a3 as __nuxt_component_1$2, X as __nuxt_component_0$e, _ as _export_sfc, B as useUI, W as __nuxt_component_0$4, y as __nuxt_component_4$3, a1 as getNuxtLinkProps } from './server.mjs';
...
import { _ as __nuxt_component_0$1 } from './LandingSection-Dlelddfd.mjs';
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_component_ULandingHero, {
        ...
        links: [
          { label: _ctx.$t("index.hero.links.searchproducts"), icon: "i-heroicons-shopping-bag", trailing: true, to: "#products", size: "xl" },
...
//# sourceMappingURL=index-BL0sjwQg.mjs.map
