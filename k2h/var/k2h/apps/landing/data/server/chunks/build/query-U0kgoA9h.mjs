import { M as withLeadingSlash, C as joinURL, I as withoutTrailingSlash, T as withBase, Q as hash } from '../nitro/nitro.mjs';
import { ag as useRuntimeConfig, ae as useRequestEvent } from './server.mjs';
...
const createQueryFetch = () => async (query) => {
  ...
  if (shouldUseClientDB()) {
    const db = await import('./client-db-CUDs7Nd8.mjs').then((m) => m.useContentDatabase());
...
//# sourceMappingURL=query-U0kgoA9h.mjs.map
