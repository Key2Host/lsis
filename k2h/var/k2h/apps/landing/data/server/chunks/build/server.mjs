import { shallowReactive, reactive, effectScope, getCurrentScope, hasInjectionContext, getCurrentInstance, toRef, inject, shallowRef, isReadonly, isRef, isShallow, isReactive, toRaw, defineAsyncComponent, unref, ref, computed, defineComponent, h, Fragment, createVNode, Text, toValue, watch, onServerPrefetch, mergeProps, useSSRContext, useAttrs, provide, withCtx, resolveDynamicComponent, createBlock, renderSlot, openBlock, toDisplayString as toDisplayString$1, resolveComponent, useSlots, createCommentVNode, toHandlers, createTextVNode, mergeModels, useModel, createSlots, renderList, nextTick, withModifiers, markRaw, useId, Suspense, createElementBlock, onErrorCaptured, createApp } from 'vue';
import { D as createHooks, E as getContext, f as createError$1, F as toRouteMatcher, G as createRouter, m as defu, H as sanitizeStatusCode, I as executeAsync, J as getRequestHeaders, K as serialize, L as destr, M as klona, N as parse$1, O as getRequestHeader, P as isEqual$1, Q as setCookie, R as getCookie, S as deleteCookie, T as defuFn, p as publicAssetsURL } from '../nitro/nitro.mjs';
...
const tv$1 = createTV((_a$n = appConfigTv$1.ui) == null ? void 0 : _a$n.tv);
          ...
          if (_push2) {
            if (_ctx.src && !error.value) {
              ...
              ssrRenderSlot(_ctx.$slots, "default", {}, () => {
                var _a4, _b2;
                if (_ctx.icon) {
                  _push2(ssrRenderComponent(__nuxt_component_1$3, {
                    name: _ctx.icon,
            ...
            return [
              _ctx.src && !error.value ? (openBlock(), createBlock(resolveDynamicComponent(unref(ImageComponent)), mergeProps({
                ...
                var _a4, _b2;
                return [
                  _ctx.icon ? (openBlock(), createBlock(__nuxt_component_1$3, {
                    key: 0,
                    name: _ctx.icon,
                    class: ui.value.icon({ class: (_a4 = props.ui) == null ? void 0 : _a4.icon })
...
const _sfc_main$v = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      var _a2;
      _push(ssrRenderComponent(__nuxt_component_0$6, mergeProps({
        type: _ctx.type,
                ...
                if (_push3) {
                  ssrRenderSlot(_ctx.$slots, "leading", {}, () => {
                    ...
                    if (unref(isLeading) && unref(leadingIconName)) {
                      _push3(ssrRenderComponent(__nuxt_component_1$3, {
                  ...
                  return [
                    renderSlot(_ctx.$slots, "leading", {}, () => {
                      var _a4, _b2, _c;
                      return [
                        unref(isLeading) && unref(leadingIconName) ? (openBlock(), createBlock(__nuxt_component_1$3, {
                          key: 0,
                          name: unref(leadingIconName),
                          class: ui.value.leadingIcon({ class: (_a4 = props.ui) == null ? void 0 : _a4.leadingIcon, active })
                    ...
                    renderSlot(_ctx.$slots, "trailing", {}, () => {
                      var _a4;
                      return [
                        unref(isTrailing) && unref(trailingIconName) ? (openBlock(), createBlock(__nuxt_component_1$3, {
                          key: 0,
                          name: unref(trailingIconName),
                          class: ui.value.trailingIcon({ class: (_a4 = props.ui) == null ? void 0 : _a4.trailingIcon, active })
...
const theme$e = {
  "slots": {
    ...
    "content": "lg:hidden",
    "overlay": "lg:hidden",
    "header": "px-4 sm:px-6 h-(--ui-header-height) shrink-0 flex items-center justify-between gap-1.5",
...
const tv = createTV((_a$f = appConfigTv.ui) == null ? void 0 : _a$f.tv);
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(unref(DefineToggleTemplate), null, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ssrRenderSlot(_ctx.$slots, "toggle", { open: open.value }, () => {
              var _a3;
              if (_ctx.toggle) {
            ...
            return [
              renderSlot(_ctx.$slots, "toggle", { open: open.value }, () => {
                var _a3;
                return [
                  _ctx.toggle ? (openBlock(), createBlock(_component_UButton, mergeProps({
                    key: 0,
                    color: "neutral",
                    variant: "ghost",
                    "aria-label": open.value ? unref(t)("header.close") : unref(t)("header.open"),
                    ...
                    class: unref(ui).toggle({ class: (_a3 = props.ui) == null ? void 0 : _a3.toggle, toggleSide: _ctx.toggleSide }),
                    onClick: ($event) => open.value = !open.value
                  }), null, 16, ["aria-label", "icon", "class", "onClick"])) : createCommentVNode("", true)
                ];
              })
            ];
          }
      ...
      _push(ssrRenderComponent(unref(DefineLeftTemplate), null, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          ...
          if (_push2) {
            ...
            return [
              createVNode("div", {
                class: unref(ui).left({ class: (_b2 = props.ui) == null ? void 0 : _b2.left })
              }, [
      ...
      _push(ssrRenderComponent(unref(DefineRightTemplate), null, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          var _a3, _b2;
          if (_push2) {
            _push2(`<div class="${ssrRenderClass(unref(ui).right({ class: (_a3 = props.ui) == null ? void 0 : _a3.right }))}"${_scopeId}>`);
            ...
            return [
              createVNode("div", {
                class: unref(ui).right({ class: (_b2 = props.ui) == null ? void 0 : _b2.right })
              }, [
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          ...
          if (_push2) {
            ...
            _push2(ssrRenderComponent(_component_UContainer, {
              class: unref(ui).container({ class: (_a3 = props.ui) == null ? void 0 : _a3.container })
            }, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                var _a4, _b3;
                if (_push3) {
                  _push3(ssrRenderComponent(unref(ReuseLeftTemplate), null, null, _parent3, _scopeId2));
                  _push3(`<div class="${ssrRenderClass(unref(ui).center({ class: (_a4 = props.ui) == null ? void 0 : _a4.center }))}"${_scopeId2}>`);
                  ssrRenderSlot(_ctx.$slots, "default", {}, null, _push3, _parent3, _scopeId2);
                  _push3(`</div>`);
                  ...
                  return [
                    ...
                    createVNode("div", {
                      class: unref(ui).center({ class: (_b3 = props.ui) == null ? void 0 : _b3.center })
                    }, [
                      renderSlot(_ctx.$slots, "default")
                    ], 2),
            ...
            return [
              ...
              createVNode(_component_UContainer, {
                class: unref(ui).container({ class: (_b2 = props.ui) == null ? void 0 : _b2.container })
              }, {
                default: withCtx(() => {
                  var _a4;
                  return [
                    createVNode(unref(ReuseLeftTemplate)),
                    createVNode("div", {
                      class: unref(ui).center({ class: (_a4 = props.ui) == null ? void 0 : _a4.center })
                    }, [
                      renderSlot(_ctx.$slots, "default")
                    ], 2),
                    createVNode(unref(ReuseRightTemplate))
      ...
      _push(ssrRenderComponent(unref(Menu), mergeProps({
        ...
        ui: {
          overlay: unref(ui).overlay({ class: (_b = props.ui) == null ? void 0 : _b.overlay }),
          content: unref(ui).content({ class: (_c = props.ui) == null ? void 0 : _c.content })
        }
      }), {
        content: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ssrRenderSlot(_ctx.$slots, "content", {}, () => {
              ...
              _push2(`<div class="${ssrRenderClass(unref(ui).body({ class: (_b2 = props.ui) == null ? void 0 : _b2.body }))}"${_scopeId}>`);
              ...
              renderSlot(_ctx.$slots, "content", {}, () => {
                ...
                return [
                  _ctx.mode !== "drawer" ? (openBlock(), createBlock("div", {
                    key: 0,
                    class: unref(ui).header({ class: (_a3 = props.ui) == null ? void 0 : _a3.header })
                  }, [
                    createVNode(unref(ReuseLeftTemplate)),
                    createVNode(unref(ReuseRightTemplate))
                  ], 2)) : createCommentVNode("", true),
                  createVNode("div", {
                    class: unref(ui).body({ class: (_b2 = props.ui) == null ? void 0 : _b2.body })
                  }, [
                    renderSlot(_ctx.$slots, "body")
                  ], 2)
                ];
            ...
            ssrRenderSlot(_ctx.$slots, item.slot || "item", {
              ...
              if ((!_ctx.collapsed || _ctx.orientation !== "vertical") && (item.badge || _ctx.orientation === "horizontal" && (((_c = item.children) == null ? void 0 : _c.length) || !!slots[item.slot ? `${item.slot}-content` : "item-content"]) || _ctx.orientation === "vertical" && ((_d = item.children) == null ? void 0 : _d.length) || item.trailingIcon || !!slots[item.slot ? `${item.slot}-trailing` : "item-trailing"])) {
                ...
                ssrRenderSlot(_ctx.$slots, item.slot ? `${item.slot}-trailing` : "item-trailing", {
                  ...
                  if (item.badge) {
                    _push2(ssrRenderComponent(__nuxt_component_0$3, mergeProps({
                      color: "neutral",
                      variant: "outline",
              ...
              renderSlot(_ctx.$slots, item.slot || "item", {
                ...
                return [
                  renderSlot(_ctx.$slots, item.slot ? `${item.slot}-leading` : "item-leading", {
                    ...
                    return [
                      item.avatar ? (openBlock(), createBlock(__nuxt_component_3$2, mergeProps({
                        ...
                        class: ui.value.linkLeadingAvatar({ class: (_b2 = props.ui) == null ? void 0 : _b2.linkLeadingAvatar, active, disabled: !!item.disabled })
                      }), null, 16, ["size", "class"])) : item.icon ? (openBlock(), createBlock(__nuxt_component_1$3, {
                        key: 1,
                        name: item.icon,
                        class: ui.value.linkLeadingIcon({ class: (_c2 = props.ui) == null ? void 0 : _c2.linkLeadingIcon, active, disabled: !!item.disabled })
                      }, null, 8, ["name", "class"])) : createCommentVNode("", true)
                  ...
                  (!_ctx.collapsed || _ctx.orientation !== "vertical") && (unref(get)(item, props.labelKey) || !!slots[item.slot ? `${item.slot}-label` : "item-label"]) ? (openBlock(), createBlock("span", {
                    ...
                    item.target === "_blank" && _ctx.externalIcon !== false ? (openBlock(), createBlock(__nuxt_component_1$3, {
                      key: 0,
                      name: typeof _ctx.externalIcon === "string" ? _ctx.externalIcon : unref(appConfig).ui.icons.external,
                      class: ui.value.linkLabelExternalIcon({ class: (_b = props.ui) == null ? void 0 : _b.linkLabelExternalIcon, active })
                    }, null, 8, ["name", "class"])) : createCommentVNode("", true)
                  ...
                  (!_ctx.collapsed || _ctx.orientation !== "vertical") && (item.badge || _ctx.orientation === "horizontal" && (((_c = item.children) == null ? void 0 : _c.length) || !!slots[item.slot ? `${item.slot}-content` : "item-content"]) || _ctx.orientation === "vertical" && ((_d = item.children) == null ? void 0 : _d.length) || item.trailingIcon || !!slots[item.slot ? `${item.slot}-trailing` : "item-trailing"]) ? (openBlock(), createBlock("span", {
                    ...
                    renderSlot(_ctx.$slots, item.slot ? `${item.slot}-trailing` : "item-trailing", {
                      ...
                      var _a4, _b2, _c2, _d2, _e2, _f;
                      return [
                        item.badge ? (openBlock(), createBlock(__nuxt_component_0$3, mergeProps({
                          key: 0,
                          color: "neutral",
                          variant: "outline",
                          size: ((_a4 = props.ui) == null ? void 0 : _a4.linkTrailingBadgeSize) || ui.value.linkTrailingBadgeSize()
                        ...
                        _ctx.orientation === "horizontal" && (((_c2 = item.children) == null ? void 0 : _c2.length) || !!slots[item.slot ? `${item.slot}-content` : "item-content"]) || _ctx.orientation === "vertical" && ((_d2 = item.children) == null ? void 0 : _d2.length) ? (openBlock(), createBlock(__nuxt_component_1$3, {
                          key: 1,
                          name: item.trailingIcon || _ctx.trailingIcon || unref(appConfig).ui.icons.chevronDown,
                          class: ui.value.linkTrailingIcon({ class: (_e2 = props.ui) == null ? void 0 : _e2.linkTrailingIcon, active })
                        }, null, 8, ["name", "class"])) : item.trailingIcon ? (openBlock(), createBlock(__nuxt_component_1$3, {
                          key: 2,
                          name: item.trailingIcon,
                          class: ui.value.linkTrailingIcon({ class: (_f = props.ui) == null ? void 0 : _f.linkTrailingIcon, active })
                        }, null, 8, ["name", "class"])) : createCommentVNode("", true)
              ...
              default: withCtx((_, _push3, _parent3, _scopeId2) => {
                ...
                if (_push3) {
                  if (_ctx.orientation === "vertical" && item.type === "label") {
                    ...
                    _push3(ssrRenderComponent(__nuxt_component_0$6, mergeProps(_ctx.orientation === "vertical" && ((_b2 = item.children) == null ? void 0 : _b2.length) && !_ctx.collapsed ? {} : unref(pickLinkProps)(item), { custom: "" }), {
                                ...
                                if (_push5) {
                                  ssrRenderSlot(_ctx.$slots, item.slot ? `${item.slot}-content` : "item-content", {
                                    ...
                                    ssrRenderList(item.children, (childItem, childIndex) => {
                                      ...
                                      _push5(ssrRenderComponent(__nuxt_component_0$6, mergeProps({ ref_for: true }, unref(pickLinkProps)(childItem), { custom: "" }), {
                                                ...
                                                if (_push7) {
                                                  _push7(ssrRenderComponent(ULinkBase, mergeProps({ ref_for: true }, childSlotProps, {
                                                    ...
                                                    default: withCtx((_4, _push8, _parent8, _scopeId7) => {
                                                      ...
                                                      if (_push8) {
                                                        if (childItem.icon) {
                                                          _push8(ssrRenderComponent(__nuxt_component_1$3, {
                                                            name: childItem.icon,
                                                        ...
                                                        return [
                                                          childItem.icon ? (openBlock(), createBlock(__nuxt_component_1$3, {
                                                            key: 0,
                                                            name: childItem.icon,
                                                          ...
                                                          createVNode("div", {
                                                            ...
                                                            createVNode("p", {
                                                              ...
                                                              childItem.target === "_blank" && _ctx.externalIcon !== false ? (openBlock(), createBlock(__nuxt_component_1$3, {
                                                                key: 0,
                                                                name: typeof _ctx.externalIcon === "string" ? _ctx.externalIcon : unref(appConfig).ui.icons.external,
                                        ...
                                        createVNode("ul", {
                                          ...
                                          (openBlock(true), createBlock(Fragment, null, renderList(item.children, (childItem, childIndex) => {
                                            ...
                                            return openBlock(), createBlock("li", {
                                              ...
                                              createVNode(__nuxt_component_0$6, mergeProps({ ref_for: true }, unref(pickLinkProps)(childItem), { custom: "" }), {
                  ...
                  return [
                    ...
                    ], 2)) : item.type !== "label" ? (openBlock(), createBlock(__nuxt_component_0$6, mergeProps({ key: 1 }, _ctx.orientation === "vertical" && ((_d2 = item.children) == null ? void 0 : _d2.length) && !_ctx.collapsed ? {} : unref(pickLinkProps)(item), { custom: "" }), {
              ...
              (openBlock(), createBlock(resolveDynamicComponent(_ctx.orientation === "vertical" && ((_d = item.children) == null ? void 0 : _d.length) && !_ctx.collapsed ? UCollapsible : unref(NavigationMenuItem)), {
                ...
                default: withCtx(() => {
                  ...
                  return [
                    ...
                    ], 2)) : item.type !== "label" ? (openBlock(), createBlock(__nuxt_component_0$6, mergeProps({ key: 1 }, _ctx.orientation === "vertical" && ((_b2 = item.children) == null ? void 0 : _b2.length) && !_ctx.collapsed ? {} : unref(pickLinkProps)(item), { custom: "" }), {
                      default: withCtx(({ active, ...slotProps }) => {
                        var _a5, _b3, _c2;
                        return [
                          (openBlock(), createBlock(resolveDynamicComponent(_ctx.orientation === "horizontal" && (((_a5 = item.children) == null ? void 0 : _a5.length) || !!slots[item.slot ? `${item.slot}-content` : "item-content"]) ? unref(NavigationMenuTrigger) : unref(NavigationMenuLink)), {
                  ...
                  renderSlot(_ctx.$slots, "default", {}, () => {
                    ...
                    return [
                      _ctx.label ? (openBlock(), createBlock("span", {
                        key: 0,
                        class: ui.value.label({ class: (_a4 = props.ui) == null ? void 0 : _a4.label })
                      }, toDisplayString$1(_ctx.label), 3)) : _ctx.icon ? (openBlock(), createBlock(__nuxt_component_1$3, {
                        key: 1,
                        name: _ctx.icon,
                        class: ui.value.icon({ class: (_b2 = props.ui) == null ? void 0 : _b2.icon })
                      }, null, 8, ["name", "class"])) : _ctx.avatar ? (openBlock(), createBlock(__nuxt_component_3$2, mergeProps({
              ...
              renderSlot(_ctx.$slots, "leading", {}, () => {
                ...
                return [
                  _ctx.avatar ? (openBlock(), createBlock(__nuxt_component_3$2, mergeProps({
                    ...
                    class: ui.value.avatar({ class: (_b2 = props.ui) == null ? void 0 : _b2.avatar })
                  }), null, 16, ["size", "class"])) : _ctx.icon ? (openBlock(), createBlock(__nuxt_component_1$3, {
                    key: 1,
                    name: _ctx.icon,
                    class: ui.value.icon({ class: (_c2 = props.ui) == null ? void 0 : _c2.icon })
                  }, null, 8, ["name", "class"])) : createCommentVNode("", true)
...
const toaster = tv$1({ extend: tv$1(theme$8), ...((_a$8 = appConfigToaster.ui) == null ? void 0 : _a$8.toaster) || {} });
const __default__$1 = {
  name: "Toaster"
};
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(unref(Primitive), mergeProps({
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          ...
          if (_push2) {
            if (!!slots.top) {
              _push2(`<div class="${ssrRenderClass(unref(ui).top({ class: (_a3 = props.ui) == null ? void 0 : _a3.top }))}"${_scopeId}>`);
              ssrRenderSlot(_ctx.$slots, "top", {}, null, _push2, _parent2, _scopeId);
              _push2(`</div>`);
            } else {
              _push2(`<!---->`);
            ...
            _push2(ssrRenderComponent(_component_UContainer, {
              class: unref(ui).container({ class: (_b = props.ui) == null ? void 0 : _b.container })
            }, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                var _a4, _b2, _c2, _d2, _e2, _f2;
                if (_push3) {
                  _push3(`<div class="${ssrRenderClass(unref(ui).right({ class: (_a4 = props.ui) == null ? void 0 : _a4.right }))}"${_scopeId2}>`);
                  ssrRenderSlot(_ctx.$slots, "right", {}, null, _push3, _parent3, _scopeId2);
                  _push3(`</div><div class="${ssrRenderClass(unref(ui).center({ class: (_b2 = props.ui) == null ? void 0 : _b2.center }))}"${_scopeId2}>`);
                  ssrRenderSlot(_ctx.$slots, "default", {}, null, _push3, _parent3, _scopeId2);
                  _push3(`</div><div class="${ssrRenderClass(unref(ui).left({ class: (_c2 = props.ui) == null ? void 0 : _c2.left }))}"${_scopeId2}>`);
                  ssrRenderSlot(_ctx.$slots, "left", {}, null, _push3, _parent3, _scopeId2);
                  _push3(`</div>`);
                } else {
                  return [
                    createVNode("div", {
                      class: unref(ui).right({ class: (_d2 = props.ui) == null ? void 0 : _d2.right })
                    }, [
                      renderSlot(_ctx.$slots, "right")
                    ], 2),
                    createVNode("div", {
                      class: unref(ui).center({ class: (_e2 = props.ui) == null ? void 0 : _e2.center })
                    }, [
                      renderSlot(_ctx.$slots, "default")
                    ], 2),
                    createVNode("div", {
                      class: unref(ui).left({ class: (_f2 = props.ui) == null ? void 0 : _f2.left })
                    }, [
                      renderSlot(_ctx.$slots, "left")
                    ], 2)
                  ];
            ...
            if (!!slots.bottom) {
              _push2(`<div class="${ssrRenderClass(unref(ui).bottom({ class: (_c = props.ui) == null ? void 0 : _c.bottom }))}"${_scopeId}>`);
              ssrRenderSlot(_ctx.$slots, "bottom", {}, null, _push2, _parent2, _scopeId);
              _push2(`</div>`);
            } else {
              _push2(`<!---->`);
            ...
            return [
              !!slots.top ? (openBlock(), createBlock("div", {
                key: 0,
                class: unref(ui).top({ class: (_d = props.ui) == null ? void 0 : _d.top })
              }, [
                renderSlot(_ctx.$slots, "top")
              ], 2)) : createCommentVNode("", true),
              createVNode(_component_UContainer, {
                class: unref(ui).container({ class: (_e = props.ui) == null ? void 0 : _e.container })
              }, {
                default: withCtx(() => {
                  var _a4, _b2, _c2;
                  return [
                    createVNode("div", {
                      class: unref(ui).right({ class: (_a4 = props.ui) == null ? void 0 : _a4.right })
                    }, [
                      renderSlot(_ctx.$slots, "right")
                    ], 2),
                    createVNode("div", {
                      class: unref(ui).center({ class: (_b2 = props.ui) == null ? void 0 : _b2.center })
                    }, [
                      renderSlot(_ctx.$slots, "default")
                    ], 2),
                    createVNode("div", {
                      class: unref(ui).left({ class: (_c2 = props.ui) == null ? void 0 : _c2.left })
                    }, [
                      renderSlot(_ctx.$slots, "left")
                    ], 2)
                  ];
              ...
              !!slots.bottom ? (openBlock(), createBlock("div", {
                key: 1,
                class: unref(ui).bottom({ class: (_f = props.ui) == null ? void 0 : _f.bottom })
              }, [
                renderSlot(_ctx.$slots, "bottom")
              ], 2)) : createCommentVNode("", true)
            ];
...
const _sfc_main$e = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      var _a2;
      const _component_ULink = __nuxt_component_0$6;
      const _component_ULinkBase = ULinkBase;
      const _component_UIcon = __nuxt_component_1$3;
      _push(ssrRenderComponent(unref(Primitive), mergeProps({
        as: _ctx.as,
        class: unref(ui).root({ class: [props.class, (_a2 = props.ui) == null ? void 0 : _a2.root] })
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          ...
          if (_push2) {
            ...
            if (!!slots.default || ((_b = _ctx.columns) == null ? void 0 : _b.length)) {
              _push2(`<div class="${ssrRenderClass(unref(ui).center({ class: (_c = props.ui) == null ? void 0 : _c.center }))}"${_scopeId}>`);
              ssrRenderSlot(_ctx.$slots, "default", {}, () => {
                _push2(`<!--[-->`);
                ssrRenderList(_ctx.columns, (column, index) => {
                  var _a4, _b2;
                  _push2(`<div${_scopeId}><h3 class="${ssrRenderClass(unref(ui).label({ class: (_a4 = props.ui) == null ? void 0 : _a4.label }))}"${_scopeId}>${ssrInterpolate(column.label)}</h3><ul class="${ssrRenderClass(unref(ui).list({ class: (_b2 = props.ui) == null ? void 0 : _b2.list }))}"${_scopeId}><!--[-->`);
                  ssrRenderList(column.children, (link, linkIndex) => {
                    var _a5;
                    _push2(`<li class="${ssrRenderClass(unref(ui).item({ class: (_a5 = props.ui) == null ? void 0 : _a5.item }))}"${_scopeId}>`);
                      ...
                      default: withCtx(({ active, ...slotProps }, _push3, _parent3, _scopeId2) => {
                        ...
                        if (_push3) {
                          _push3(ssrRenderComponent(_component_ULinkBase, mergeProps({ ref_for: true }, slotProps, {
                            class: unref(ui).link({ class: [(_a6 = props.ui) == null ? void 0 : _a6.link, link.class], active })
                          }), {
                            default: withCtx((_2, _push4, _parent4, _scopeId3) => {
                              if (_push4) {
                                ssrRenderSlot(_ctx.$slots, "link", {
                                  ...
                                  ssrRenderSlot(_ctx.$slots, "link-leading", {
                                    ...
                                    if (link.icon) {
                                      _push4(ssrRenderComponent(_component_UIcon, {
                                        name: link.icon,
                                        class: unref(ui).linkLeadingIcon({ class: (_a8 = props.ui) == null ? void 0 : _a8.linkLeadingIcon, active })
                                  ...
                                  if (link.label || !!slots["link-label"]) {
                                    _push4(`<span class="${ssrRenderClass(unref(ui).linkLabel({ class: (_a7 = props.ui) == null ? void 0 : _a7.linkLabel, active }))}"${_scopeId3}>`);
                                    ...
                                    if (link.target === "_blank") {
                                      _push4(ssrRenderComponent(_component_UIcon, {
                                        ...
                                        class: unref(ui).linkLabelExternalIcon({ class: (_b4 = props.ui) == null ? void 0 : _b4.linkLabelExternalIcon, active })
                                      }, null, _parent4, _scopeId3));
                                    } else {
                                      _push4(`<!---->`);
                                    }
                                  ...
                                  renderSlot(_ctx.$slots, "link", {
                                    ...
                                    return [
                                      ...
                                      link.label || !!slots["link-label"] ? (openBlock(), createBlock("span", {
                                        key: 0,
                                        class: unref(ui).linkLabel({ class: (_a7 = props.ui) == null ? void 0 : _a7.linkLabel, active })
                                      }, [
                          ...
                          return [
                            createVNode(_component_ULinkBase, mergeProps({ ref_for: true }, slotProps, {
                              class: unref(ui).link({ class: [(_b3 = props.ui) == null ? void 0 : _b3.link, link.class], active })
                            }), {
                              default: withCtx(() => [
                                renderSlot(_ctx.$slots, "link", {
                                  link,
            ...
            if (!!slots.right) {
              _push2(`<div class="${ssrRenderClass(unref(ui).right({ class: (_d = props.ui) == null ? void 0 : _d.right }))}"${_scopeId}>`);
              ssrRenderSlot(_ctx.$slots, "right", {}, null, _push2, _parent2, _scopeId);
              _push2(`</div>`);
            } else {
              _push2(`<!---->`);
            ...
            return [
              !!slots.left ? (openBlock(), createBlock("div", {
                key: 0,
                class: unref(ui).left({ class: (_e = props.ui) == null ? void 0 : _e.left })
              }, [
                renderSlot(_ctx.$slots, "left")
              ], 2)) : createCommentVNode("", true),
              !!slots.default || ((_f = _ctx.columns) == null ? void 0 : _f.length) ? (openBlock(), createBlock("div", {
                key: 1,
                class: unref(ui).center({ class: (_g = props.ui) == null ? void 0 : _g.center })
              }, [
                renderSlot(_ctx.$slots, "default", {}, () => [
                  (openBlock(true), createBlock(Fragment, null, renderList(_ctx.columns, (column, index) => {
                    var _a4, _b2;
                    return openBlock(), createBlock("div", { key: index }, [
                      createVNode("h3", {
                        class: unref(ui).label({ class: (_a4 = props.ui) == null ? void 0 : _a4.label })
                      }, toDisplayString$1(column.label), 3),
                      createVNode("ul", {
                        class: unref(ui).list({ class: (_b2 = props.ui) == null ? void 0 : _b2.list })
                      }, [
                                        ...
                                        return [
                                          ...
                                          link.label || !!slots["link-label"] ? (openBlock(), createBlock("span", {
                                            ...
                                            link.target === "_blank" ? (openBlock(), createBlock(_component_UIcon, {
                                              key: 0,
                                              name: unref(appConfig).ui.icons.external,
                                              class: unref(ui).linkLabelExternalIcon({ class: (_b3 = props.ui) == null ? void 0 : _b3.linkLabelExternalIcon, active })
                                            }, null, 8, ["name", "class"])) : createCommentVNode("", true)
                                          ], 2)) : createCommentVNode("", true),
                                          renderSlot(_ctx.$slots, "link-trailing", {
                                            link,
              ...
              !!slots.right ? (openBlock(), createBlock("div", {
                key: 2,
                class: unref(ui).right({ class: (_h = props.ui) == null ? void 0 : _h.right })
              }, [
                renderSlot(_ctx.$slots, "right")
              ], 2)) : createCommentVNode("", true)
            ];
              ...
              createVNode("div", {
                ...
                typeof error.value === "string" && error.value || !!slots.error ? (openBlock(), createBlock("p", {
                  ...
                  renderSlot(_ctx.$slots, "help", { help: _ctx.help }, () => [
                    createTextVNode(toDisplayString$1(_ctx.help), 1)
                  ])
                ], 2)) : createCommentVNode("", true)
              ], 2)
            ];
            ...
            return [
              ...
              unref(isTrailing) || !!slots.trailing ? (openBlock(), createBlock("span", {
                ...
                renderSlot(_ctx.$slots, "trailing", {}, () => {
                  var _a4;
                  return [
                    unref(trailingIconName) ? (openBlock(), createBlock(__nuxt_component_1$3, {
                      key: 0,
                      name: unref(trailingIconName),
                      class: ui.value.trailingIcon({ class: (_a4 = props.ui) == null ? void 0 : _a4.trailingIcon })
                    }, null, 8, ["name", "class"])) : createCommentVNode("", true)
...
const _sfc_main$a = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      const _component_USeparator = __nuxt_component_2$2;
      const _component_UFooter = __nuxt_component_1$1;
      const _component_UContainer = __nuxt_component_0$5;
              ...
              _push2(ssrRenderComponent(unref(DropdownMenu).ItemIndicator, { "as-child": "" }, {
                default: withCtx((_, _push3, _parent3, _scopeId2) => {
                  ...
                  if (_push3) {
                    ...
                    return [
                      createVNode(__nuxt_component_1$3, {
                        name: _ctx.checkedIcon || unref(appConfig).ui.icons.check,
              ...
              renderSlot(_ctx.$slots, item.slot || "item", {
                ...
                return [
                  renderSlot(_ctx.$slots, item.slot ? `${item.slot}-leading` : "item-leading", {
                    ...
                    var _a2, _b2, _c2, _d;
                    return [
                      item.loading ? (openBlock(), createBlock(__nuxt_component_1$3, {
                        key: 0,
                        name: _ctx.loadingIcon || unref(appConfig).ui.icons.loading,
                        class: _ctx.ui.itemLeadingIcon({ class: (_a2 = _ctx.uiOverride) == null ? void 0 : _a2.itemLeadingIcon, color: item == null ? void 0 : item.color, loading: true })
                      }, null, 8, ["name", "class"])) : item.icon ? (openBlock(), createBlock(__nuxt_component_1$3, {
                        key: 1,
                        name: item.icon,
                        class: _ctx.ui.itemLeadingIcon({ class: (_b2 = _ctx.uiOverride) == null ? void 0 : _b2.itemLeadingIcon, color: item == null ? void 0 : item.color, active })
                  ...
                  createVNode("span", {
                    ...
                    renderSlot(_ctx.$slots, item.slot ? `${item.slot}-trailing` : "item-trailing", {
                      ...
                      var _a2, _b2, _c2, _d;
                      return [
                        ((_a2 = item.children) == null ? void 0 : _a2.length) ? (openBlock(), createBlock(__nuxt_component_1$3, {
                          key: 0,
                          name: unref(appConfig).ui.icons.chevronRight,
                          class: _ctx.ui.itemTrailingIcon({ class: (_b2 = _ctx.uiOverride) == null ? void 0 : _b2.itemTrailingIcon, color: item == null ? void 0 : item.color, active })
                          ...
                          ssrRenderList(group, (item, index) => {
                            ...
                            if (item.type === "label") {
                              ...
                              _push4(ssrRenderComponent(unref(DropdownMenu).Item, {
                                ...
                                default: withCtx((_4, _push5, _parent5, _scopeId4) => {
                                  if (_push5) {
                                    _push5(ssrRenderComponent(__nuxt_component_0$6, mergeProps({ ref_for: true }, unref(pickLinkProps)(item), { custom: "" }), {
                                    ...
                                    return [
                                      createVNode(__nuxt_component_0$6, mergeProps({ ref_for: true }, unref(pickLinkProps)(item), { custom: "" }), {
                                        default: withCtx(({ active, ...slotProps }) => {
                                          var _a3;
                                          return [
                                            createVNode(ULinkBase, mergeProps({ ref_for: true }, slotProps, {
                            ...
                            default: withCtx((_3, _push5, _parent5, _scopeId4) => {
                              ...
                              if (_push5) {
                                ssrRenderSlot(_ctx.$slots, "leading", {
                                  ...
                                  var _a7;
                                  if (item.icon) {
                                    _push5(ssrRenderComponent(__nuxt_component_1$3, {
                                      name: item.icon,
                                ...
                                return [
                                  renderSlot(_ctx.$slots, "leading", {
                                    ...
                                    var _a7;
                                    return [
                                      item.icon ? (openBlock(), createBlock(__nuxt_component_1$3, {
                                        key: 0,
                                        name: item.icon,
                                        class: ui.value.leadingIcon({ class: (_a7 = props.ui) == null ? void 0 : _a7.leadingIcon })
                                      }, null, 8, ["name", "class"])) : createCommentVNode("", true)
...
const _sfc_main$2 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      const _component_LangNotice = __nuxt_component_1$2;
      const _component_UApp = __nuxt_component_2$1;
