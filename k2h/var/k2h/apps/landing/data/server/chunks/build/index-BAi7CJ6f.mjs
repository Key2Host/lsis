...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  async setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (unref(step) == 2) {
        _push(`<small class="opacity-75">${ssrInterpolate(_ctx.$t("checkout.index.steps.2.loggedInAs"))} ${ssrInterpolate(unref(userName) || _ctx.$t("checkout.index.steps.2.unknownUser"))}. <a href="" class="text-primary underline">${ssrInterpolate(_ctx.$t("checkout.index.steps.2.notYou"))}?</a></small>`);
      } else {
        _push(`<!---->`);
      }
      _push(`</div></div>`);
...
//# sourceMappingURL=index-BAi7CJ6f.mjs.map
