...
import { ak as useState, ai as useAsyncData, ag as useRuntimeConfig, X as __nuxt_component_0$e } from './server.mjs';
import { u as useContentDisabled, q as queryContent, w as withContentBase, e as encodeQueryParams, a as addPrerenderPath, s as shouldUseClientDB, j as jsonStringify } from './query-U0kgoA9h.mjs';
import { u as useContentPreview } from './preview-BY4YMJUp.mjs';
...
const fetchContentNavigation = async (queryBuilder) => {
  ...
  if (shouldUseClientDB()) {
    const generateNavigation = await import('./client-db-CUDs7Nd8.mjs').then((m) => m.generateNavigation);
...
//# sourceMappingURL=ContentNavigation-CVmvBPwO.mjs.map
