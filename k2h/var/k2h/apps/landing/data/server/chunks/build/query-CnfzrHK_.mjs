import { av as withBase, aq as useRuntimeConfig, aj as withLeadingSlash, al as joinURL, at as withoutTrailingSlash, ai as useRequestEvent } from './server.mjs';
...
const createQueryFetch = () => async (query) => {
  ...
  if (shouldUseClientDB()) {
    const db = await import('./client-db-Co86caWM.mjs').then((m) => m.useContentDatabase());
...
//# sourceMappingURL=query-CnfzrHK_.mjs.map
