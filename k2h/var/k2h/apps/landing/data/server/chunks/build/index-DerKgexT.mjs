...
import { defineComponent, withAsyncContext, withCtx, createVNode, toDisplayString, createBlock, createCommentVNode, openBlock, Fragment, renderList, createTextVNode, toRef, mergeProps, unref, computed, createSlots, renderSlot, ref, watch, toRaw, useSSRContext } from 'vue';
...
import { u as useI18n, a as useSeoMeta, W as useCartStore, _ as _export_sfc, C as useUI, Z as useAppConfig, X as __nuxt_component_0$4, a3 as __nuxt_component_1$2, Q as __nuxt_component_2$3, y as __nuxt_component_1$3, P as __nuxt_component_0$9, B as mergeConfig, J as get, I as appConfig } from './server.mjs';
import { twJoin } from 'tailwind-merge';
import { _ as __nuxt_component_3 } from './Skeleton-C2x-ih_d.mjs';
import { a as __nuxt_component_5, b as __nuxt_component_0$1, _ as __nuxt_component_2$1 } from './Alert-DxePXqb0.mjs';
  ...
  async setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
          ...
          if (_push2) {
            ...
            ssrRenderList(packages, (packageItem, index) => {
              _push2(ssrRenderComponent(_component_UPricingCard, {
                ...
                price: packageItem.amount + _ctx.$t("currency.symbol"),
                discount: "",
      ...
      _push(ssrRenderComponent(_component_UAlert, {
        class: "mt-4",
        actions: [{ variant: "solid", color: "primary", label: _ctx.$t("products.webspace.domain.action"), to: "/products/domain" }]
      }, {
...
//# sourceMappingURL=index-DerKgexT.mjs.map
