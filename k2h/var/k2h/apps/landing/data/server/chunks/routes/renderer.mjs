...
import { b as buildAssetsURL, u as useRuntimeConfig, g as getResponseStatusText, a as getResponseStatus, c as defineRenderHandler, p as publicAssetsURL, e as getQuery, f as createError, h as getRouteRules, i as useNitroApp } from '../nitro/nitro.mjs';
...
const getServerEntry = () => import('../build/server.mjs').then(function (n) { return n.ap; }).then((r) => r.default || r);
