  ...
  setup(__props) {
    ...
    async function postContact(event) {
      ...
      try {
        ...
        toast.add({
          icon: "i-heroicons-exclamation-triangle",
          description: "Das CAPTCHA wurde nicht verifiziert. Versuche es erneut.",
          color: "red",
            ...
            _push2(ssrRenderComponent(_component_UPageCard, {
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  ...
                  _push3(ssrRenderComponent(unref(VueTurnstile), {
                    "site-key": "0x4AAAAAAA_Rsp0FMzxn96X3",
                    theme: "auto",
                  ...
                  return [
                    createVNode("form", {
                      ...
                      createVNode(unref(VueTurnstile), {
                        "site-key": "0x4AAAAAAA_Rsp0FMzxn96X3",
                        theme: "auto",
                        modelValue: turnstileToken.value,
                        "onUpdate:modelValue": ($event) => turnstileToken.value = $event
...
//# sourceMappingURL=contact-Co9rbQWJ.mjs.map
