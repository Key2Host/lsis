    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_component_UPageBody, { class: "m-6 w-full max-w-4xl" }, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="text-center mb-4"${_scopeId}><h1 class="text-2xl font-bold mb-3"${_scopeId}>${ssrInterpolate(_ctx.$t("legal.notice.provider"))}</h1><p class="text-lg leading-6"${_scopeId}><span class="font-medium"${_scopeId}>Key2Host</span><br${_scopeId}> Ottenweg 19<br${_scopeId}> 49479 Ibbenb\xFCren<br${_scopeId}> Deutschland (Germany) </p></div><div class="mb-6"${_scopeId}><h2 class="text-lg font-semibold text-center"${_scopeId}>${ssrInterpolate(_ctx.$t("legal.notice.ceo"))}</h2><p class="text-lg leading-6 text-center"${_scopeId}> Lukas Poggemann </p></div><div class="text-center mb-6"${_scopeId}><h1 class="text-2xl font-bold mb-3"${_scopeId}>${ssrInterpolate(_ctx.$t("legal.notice.contact.title"))}</h1><p class="text-lg leading-6 text-center"${_scopeId}>${ssrInterpolate(_ctx.$t("legal.notice.contact.email"))}: <a href="mailto:info@key2host.com" class="text-primary underline"${_scopeId}>info@key2host.com</a><br${_scopeId}> ${ssrInterpolate(_ctx.$t("legal.notice.contact.phone"))}: <a href="tel:+4915146274092" class="text-primary underline"${_scopeId}>+49 1514 6274092</a></p></div><div class="text-center mb-6"${_scopeId}><h1 class="text-2xl font-bold mb-3"${_scopeId}>${ssrInterpolate(_ctx.$t("legal.notice.vat.title"))}</h1><p class="text-lg leading-6 text-center"${_scopeId}> DE XXXXXXXXX<br${_scopeId}><small${_scopeId}>${ssrInterpolate(_ctx.$t("legal.notice.vat.notice"))}</small></p></div><div class="text-center mb-6"${_scopeId}><h1 class="text-2xl font-bold mb-3"${_scopeId}>${ssrInterpolate(_ctx.$t("legal.notice.dispute.title"))}</h1><p class="text-lg leading-6 text-center"${_scopeId}> Die Europ\xE4ische Kommission stellt eine Plattform zur Online-Streitbeilegung (OS) bereit, die Sie unter <a href="https://ec.europa.eu/consumers/odr/" class="text-primary underline" target="_blank"${_scopeId}>https://ec.europa.eu/consumers/odr/</a> finden. Verbraucher haben die M\xF6glichkeit, diese Plattform f\xFCr die Beilegung ihrer Streitigkeiten zu nutzen.<br${_scopeId}> Wir sind zur Beilegung von Streitigkeiten mit Verbrauchern vor einer Verbraucherschlichtungsstelle bereit. </p></div><div class="text-center mb-6"${_scopeId}><h1 class="text-2xl font-bold mb-3"${_scopeId}>${ssrInterpolate(_ctx.$t("legal.notice.socialmedia.title"))}</h1><p class="text-lg leading-6 text-center"${_scopeId}>${ssrInterpolate(_ctx.$t("legal.notice.socialmedia.description"))}</p></div><div class="text-center"${_scopeId}><h1 class="text-2xl font-bold mb-3"${_scopeId}>${ssrInterpolate(_ctx.$t("legal.notice.liability.title"))}</h1><ul class="text-lg leading-6 text-center"${_scopeId}><li${_scopeId}><span class="font-bold"${_scopeId}>${ssrInterpolate(_ctx.$t("legal.notice.liability.items.1.title"))}:</span> ${ssrInterpolate(_ctx.$t("legal.notice.liability.items.1.description"))}</li><br${_scopeId}><li${_scopeId}><span class="font-bold"${_scopeId}>${ssrInterpolate(_ctx.$t("legal.notice.liability.items.2.title"))}:</span> ${ssrInterpolate(_ctx.$t("legal.notice.liability.items.2.description"))}</li><br${_scopeId}><li${_scopeId}><span class="font-bold"${_scopeId}>${ssrInterpolate(_ctx.$t("legal.notice.liability.items.3.title"))}:</span> ${ssrInterpolate(_ctx.$t("legal.notice.liability.items.3.description"))}</li><br${_scopeId}><li${_scopeId}><span class="font-bold"${_scopeId}>${ssrInterpolate(_ctx.$t("legal.notice.liability.items.4.title"))}:</span> ${ssrInterpolate(_ctx.$t("legal.notice.liability.items.4.description"))}</li></ul></div>`);
          } else {
            return [
              ...
              createVNode("div", { class: "text-center mb-6" }, [
                ...
                createVNode("p", { class: "text-lg leading-6 text-center" }, [
                  createTextVNode(" Die Europ\xE4ische Kommission stellt eine Plattform zur Online-Streitbeilegung (OS) bereit, die Sie unter "),
                  createVNode("a", {
                    href: "https://ec.europa.eu/consumers/odr/",
                    class: "text-primary underline",
                    target: "_blank"
                  }, "https://ec.europa.eu/consumers/odr/"),
                  createTextVNode(" finden. Verbraucher haben die M\xF6glichkeit, diese Plattform f\xFCr die Beilegung ihrer Streitigkeiten zu nutzen."),
                  createVNode("br"),
