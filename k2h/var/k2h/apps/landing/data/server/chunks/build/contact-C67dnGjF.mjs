...
import { _ as __nuxt_component_2 } from './PageCard-B9-itDk8.mjs';
import { LMap, LTileLayer, LMarker } from '@vue-leaflet/vue-leaflet';
import { _ as __nuxt_component_3 } from './Skeleton-C2x-ih_d.mjs';
import { V as useToast, a0 as useCookieNoticeStore, u as useI18n, a as useSeoMeta, Y as __nuxt_component_0$e, Z as useAppConfig, C as useUI, $ as __nuxt_component_0$3, P as __nuxt_component_0$9, y as __nuxt_component_1$3 } from './server.mjs';
import { defineComponent, ref, withCtx, unref, createVNode, createBlock, createTextVNode, toDisplayString, openBlock, withDirectives, vModelText, computed, toRef, mergeProps, renderSlot, useSSRContext } from 'vue';
import { ssrRenderAttrs, ssrRenderComponent, ssrInterpolate, ssrRenderAttr, ssrIncludeBooleanAttr, ssrRenderSlot, ssrRenderClass } from 'vue/server-renderer';
...
const __nuxt_component_8 = Object.assign(_sfc_main$1, { __name: "ULandingFAQ" });
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      const _component_ULandingFAQ = __nuxt_component_8;
          ...
          if (_push2) {
            _push2(ssrRenderComponent(_component_UPageCard, {
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<ul class="mt-4 text-gray-700 space-y-2"${_scopeId2}><li${_scopeId2}><strong${_scopeId2}>${ssrInterpolate(_ctx.$t("contact.information.phone"))}:</strong> +49 1514 6274092</li><li${_scopeId2}><strong${_scopeId2}>${ssrInterpolate(_ctx.$t("contact.information.email"))}:</strong> help@key2host.com</li><li${_scopeId2}><strong${_scopeId2}>${ssrInterpolate(_ctx.$t("contact.information.address"))}:</strong> Ottenweg 19, 49479 Ibbenb\xFCren</li></ul>`);
                  if (unref(cookienotice).isConsentAll()) {
                    _push3(`<div class="mt-4 w-full h-64 rounded-md border border-gray-300"${_scopeId2}>`);
                  ...
                  return [
                    createVNode("ul", { class: "mt-4 text-gray-700 space-y-2" }, [
                      ...
                      createVNode("li", null, [
                        ...
                        createTextVNode(" Ottenweg 19, 49479 Ibbenb\xFCren")
                      ])
                    ]),
            ...
            _push2(ssrRenderComponent(_component_UPageCard, {
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  ...
                  _push3(` einverstanden. </label></div><button type="submit" class="bg-blue-600 text-white px-4 py-2 rounded-md hover:bg-blue-700 transition"${ssrIncludeBooleanAttr(messageSent.value) ? " disabled" : ""}${_scopeId2}>${ssrInterpolate(_ctx.$t("contact.contactform.inputs.submit"))}</button></form>`);
                } else {
                  return [
                    createVNode("form", {
                      ...
                      createVNode("div", null, [
                        ...
                        }, toDisplayString(_ctx.$t("contact.contactform.inputs.message.words")) + ": 0/500", 1)
                      ]),
                      createVNode("div", { class: "flex items-center" }, [
                        ...
                        createVNode("label", {
                          ...
                          createTextVNode("Hiermit erkl\xE4ren Sie sich mit unseren "),
                      ...
                      createVNode("button", {
                        ...
                        disabled: messageSent.value
                      }, toDisplayString(_ctx.$t("contact.contactform.inputs.submit")), 9, ["disabled"])
                    ], 32)
                  ];
                }
              }),
...
//# sourceMappingURL=contact-C67dnGjF.mjs.map
