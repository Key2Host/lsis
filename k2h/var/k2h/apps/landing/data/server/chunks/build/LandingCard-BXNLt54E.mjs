import { a4 as nuxtLinkProps, a9 as config$i, F as useUI, a0 as getNuxtLinkProps, a5 as getSlotChildrenText, _ as _export_sfc, W as __nuxt_component_0$4, X as __nuxt_component_0$e, C as __nuxt_component_1$3 } from './server.mjs';
import { defineComponent, computed, ref, useSlots, toRef, unref, mergeProps, withCtx, createVNode, openBlock, createBlock, createCommentVNode, renderSlot, createTextVNode, toDisplayString, useSSRContext } from 'vue';
...
function useSharedMouseInElement(target, options = {}) {
  ...
  const targetRef = ref(target ?? undefined);
  ...
  if (defaultWindow) {
    watchThrottled(
      ...
      () => {
        ...
        if (Math.abs(eX) > 1500 || Math.abs(eY) > 1500 || ((_a = defaultWindow.screen) == null ? undefined : _a.width) <= 800) {
          return;
        }
        elementX.value = eX;
        elementY.value = eY;
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    const colorLight = computed(() => {
      ...
      return ((_a = config$i[props.color]) == null ? undefined : _a["500"]) || config$i[props.color] || props.color;
    });
    const colorDark = computed(() => {
      ...
      return ((_a = config$i[props.color]) == null ? undefined : _a["400"]) || config$i[props.color] || props.color;
    });
          ...
          if (_push2) {
            ...
            return [
              createVNode("div", {
                ...
                renderSlot(_ctx.$slots, "container", {}, undefined, true)
              ], 2),
              _ctx.$slots.default ? renderSlot(_ctx.$slots, "default", { key: 0 }, undefined, true) : createCommentVNode("", true)
            ];
          }
        }),
        _: 3
...
//# sourceMappingURL=LandingCard-BXNLt54E.mjs.map
