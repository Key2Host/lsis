const resource = {
  ...
  "captcha": {
    "failed": {
      "title": { "t": 0, "b": { "t": 2, "i": [{ "t": 3 }], "s": "CAPTCHA-Problem" } },
      "description": { "t": 0, "b": { "t": 2, "i": [{ "t": 3 }], "s": "Das CAPTCHA wurde abgelehnt. Versuche es später erneut." } }
    },
    "error": {
      "title": { "t": 0, "b": { "t": 2, "i": [{ "t": 3 }], "s": "CAPTCHA-Fehler" } },
      "description": { "t": 0, "b": { "t": 2, "i": [{ "t": 3 }], "s": "Das CAPTCHA konnte nicht überprüft werden. Versuche es später erneut." } }
    }
  }
};

export { resource as default };
//# sourceMappingURL=de-DE-CnNCaC2Z.mjs.map
