      ...
      try {
        ...
        if (!response.success) {
          toast.add({
            ...
            description: "Das CAPTCHA hat deine Anfrage abgelehnt. Versuche es erneut.",
            color: "red",
        ...
        toast.add({
          icon: "i-heroicons-exclamation-triangle",
          description: "Das CAPTCHA konnte nicht überprüft werden.",
          color: "red",
          title: "CAPTCHA Fehler",
          timeout: 5e3,
          pauseTimeoutOnHover: true
...
//# sourceMappingURL=index-QjM84Ytc.mjs.map
