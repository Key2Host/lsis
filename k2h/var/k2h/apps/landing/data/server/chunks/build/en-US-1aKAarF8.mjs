const resource = {
  "currency": {
    "name": { "t": 0, "b": { "t": 2, "i": [{ "t": 3 }], "s": "Dollar" } },
    "short": { "t": 0, "b": { "t": 2, "i": [{ "t": 3 }], "s": "USD" } },
    "symbol": { "t": 0, "b": { "t": 2, "i": [{ "t": 3 }], "s": "$" } }
  },
  "menus": {
    "header": {
  ...
  "legal": {
    "notice": {
      ...
      "vat": {
        ...
        "notice": { "t": 0, "b": { "t": 2, "i": [{ "t": 3 }], "s": "According to \xA719 UStG (the German law) Key2Host does not charge sales tax due to the application of the small business regulation." } }
      },
      "dispute": {
  ...
  "checkout": {
    ...
    "failed": {
      ...
      "actions": {
        "home": { "t": 0, "b": { "t": 2, "i": [{ "t": 3 }], "s": "Zur\xFCck zur Startseite" } }
      },
      "content": {
        "1": { "t": 0, "b": { "t": 2, "i": [{ "t": 3 }], "s": "Die Zahlung konnte nicht \xFCbermittelt werden. Versuche es erneut oder kontaktiere den Support." } },
    ...
    "success": {
      ...
      "description": { "t": 0, "b": { "t": 2, "i": [{ "t": 3 }], "s": "Vielen Dank f\xFCr dein Vertrauen in Key2Host." } },
      "actions": {
        "home": { "t": 0, "b": { "t": 2, "i": [{ "t": 3 }], "s": "Zur\xFCck zur Startseite" } },
        "cp": { "t": 0, "b": { "t": 2, "i": [{ "t": 3 }], "s": "Zum Control-Panel" } }
      },
      "content": {
        "1": { "t": 0, "b": { "t": 2, "i": [{ "t": 3 }], "s": "Die Transaktion wurde erfolgreich bearbeitet. Die Rechnung erh\xE4ltst du automatisch via E-Mail." } },
        "2": { "t": 0, "b": { "t": 2, "i": [{ "t": 3 }], "s": "Bitte habe einen Moment Geduld, w\xE4hrend dein Service automatisch vom System angelegt wird." } }
      }
    }
  },
  "authform": {
...
//# sourceMappingURL=en-US-1aKAarF8.mjs.map
