...
import { m as defu, L as isEqual } from '../nitro/nitro.mjs';
import { twJoin } from 'tailwind-merge';
import { _ as __nuxt_component_8 } from './NuxtTurnstile-2T1F6ZyB.mjs';
      ...
      _push(ssrRenderComponent(_component_UAuthForm, mergeProps({
        ...
        validation: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            _push2(ssrRenderComponent(_component_NuxtTurnstile, null, null, _parent2, _scopeId));
          } else {
            return [
...
//# sourceMappingURL=index-BTYsdm_r.mjs.map
