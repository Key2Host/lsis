...
import { W as useCartStore, u as useI18n, a as useSeoMeta } from './server.mjs';
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_component_ULandingHero, mergeProps({
        ...
        links: [{ label: _ctx.$t("checkout.success.actions.cp"), icon: "i-heroicons-rocket-launch", size: "lg", to: "https://cp.key2host.com" }, { label: _ctx.$t("checkout.success.actions.home"), icon: "i-heroicons-arrow-small-left", color: "gray", size: "lg", to: "/" }]
      }, _attrs), {
...
//# sourceMappingURL=success-MG4WjDLA.mjs.map
