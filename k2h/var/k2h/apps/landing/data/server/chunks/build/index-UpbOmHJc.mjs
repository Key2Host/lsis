...
import { W as useToast, X as useCartStore, a as useI18n, b as useSeoMeta, Y as __nuxt_component_0$4, Z as __nuxt_component_2$4, Q as __nuxt_component_0$b, z as __nuxt_component_1$3, V as __nuxt_component_6$1, S as __nuxt_component_7, D as useUI, R as __nuxt_component_2$3, U as omit, _ as _export_sfc, B as __nuxt_component_4$3, C as mergeConfig, F as usePopper, G as useInjectButtonGroup, H as useFormGroup, I as twMerge, J as appConfig, K as get, L as s$5, M as select, P as selectMenu, i as i$6, h as u$7, v as p, p as c$1, d as o$2, e as u$5, A as A$3, l as l$2, f as i$1, N as N$4, s as s$3, w as w$2, x as w$4, y as h, t as t$2, j as f$2, E as E$2, k as u$4, T as T$2, c as i$4, g as i$2, n as o$1, r as f$1, m as t$1, o as o$4, q as n$2, O as O$2 } from './server.mjs';
import { defineComponent, ref, withAsyncContext, mergeProps, unref, withCtx, createTextVNode, toDisplayString, createVNode, createBlock, createCommentVNode, openBlock, Fragment, renderList, withModifiers, reactive, computed, toRef, createSlots, renderSlot, useId, provide, readonly, resolveComponent, resolveDynamicComponent, Transition, toRaw, watch, onMounted, onUnmounted, watchEffect, nextTick, h as h$1, inject, cloneVNode, useSSRContext } from 'vue';
import { useEventBus, computedAsync, useDebounceFn } from '@vueuse/core';
import { ssrRenderAttrs, ssrRenderComponent, ssrInterpolate, ssrRenderList, ssrRenderClass, ssrRenderSlot, ssrRenderVNode, ssrRenderAttr, ssrIncludeBooleanAttr, ssrRenderStyle } from 'vue/server-renderer';
...
let ie = Symbol("VirtualContext"), Ae$1 = defineComponent({ name: "VirtualProvider", setup(a, { slots: h$12 }) {
  ...
  let o2 = ref(1), u2 = ref(null), e$1 = ref(null), c$1$1 = ref(null), f2 = ref(null), S = ref({ static: false, hold: false }), v = ref([]), d$1 = ref(null), D = ref(2), E$1 = ref(false);
  ...
  let M = computed(() => a.multiple ? 1 : 0), $2 = computed(() => a.nullable), [B, p2] = d(computed(() => a.modelValue), (t2) => y("update:modelValue", t2), computed(() => a.defaultValue)), R = computed(() => B.value === void 0 ? u$7(M.value, { [1]: [], [0]: void 0 }) : B.value), V = null, i2 = null;
  function I(t2) {
  ...
  }, defaultValue: computed(() => a.defaultValue), nullable: $2, immediate: computed(() => false), virtual: computed(() => null), inputRef: e$1, labelRef: u2, buttonRef: c$1$1, optionsRef: f2, disabled: computed(() => a.disabled), options: v, change(t2) {
    p2(t2);
...
let nt = defineComponent({ name: "ComboboxButton", props: { as: { type: [Object, String], default: "button" }, id: { type: String, default: null } }, setup(a, { attrs: h2, slots: r, expose: y }) {
  ...
  return () => {
    var E2, w2;
    let v = { open: u2.comboboxState.value === 0, disabled: u2.disabled.value, value: u2.value.value }, { ...d2 } = a, D = { ref: u2.buttonRef, id: o2, type: f2.value, tabindex: "-1", "aria-haspopup": "listbox", "aria-controls": (E2 = o$2(u2.optionsRef)) == null ? void 0 : E2.id, "aria-expanded": u2.comboboxState.value === 0, "aria-labelledby": u2.labelRef.value ? [(w2 = o$2(u2.labelRef)) == null ? void 0 : w2.id, o2].join(" ") : void 0, disabled: u2.disabled.value === true ? true : void 0, onKeydown: c$1$1, onClick: e2 };
  ...
  var V;
  let u2 = (V = a.id) != null ? V : `headlessui-combobox-input-${i$6()}`, e2 = K("ComboboxInput"), c$1$1 = computed(() => i$4(o$2(e2.inputRef))), f2 = { value: false };
  ...
  onMounted(() => {
    watch([v, e2.comboboxState, c$1$1], ([i2, I], [T2, l2]) => {
      ...
      g2 && ((l2 === 0 && I === 1 || i2 !== T2) && (g2.value = i2), requestAnimationFrame(() => {
        var s2;
        if (f2.value || !g2 || ((s2 = c$1$1.value) == null ? void 0 : s2.activeElement) !== g2) return;
  ...
  return () => {
    var D, E2, w2;
    let S = { open: o2.comboboxState.value === 0 }, v = { "aria-labelledby": (w2 = (D = o$2(o2.labelRef)) == null ? void 0 : D.id) != null ? w2 : (E2 = o$2(o2.buttonRef)) == null ? void 0 : E2.id, id: u2, ref: o2.optionsRef, role: "listbox", "aria-multiselectable": o2.mode.value === 1 ? true : void 0, onMousedown: f2 }, d2 = T$2(a, ["hold"]);
    return A$3({ ourProps: v, theirProps: d2, slot: S, attrs: h$12, slots: o2.virtual.value && o2.comboboxState.value === 0 ? { ...r, default: () => [h$1(Ae$1, {}, r.default)] } : r, features: N$4.RenderStrategy | N$4.Static, visible: c2.value, name: "ComboboxOptions" });
  };
  ...
  let o2 = K("ComboboxOption"), u$12 = `headlessui-combobox-option-${i$6()}`, e2 = ref(null), c$1$1 = computed(() => a.disabled);
  y({ el: e2, $el: e2 });
  let f2 = computed(() => {
    var p2;
  ...
  function D(p2) {
    p2.preventDefault(), p2.button === g.Left && (c$1$1.value || (o2.selectOption(u$12), n$2() || requestAnimationFrame(() => {
      var R;
  ...
  return () => {
    let { disabled: p2 } = a, R = { active: f2.value, selected: S.value, disabled: p2 }, V = { id: u$12, ref: e2, role: "option", tabIndex: p2 === true ? void 0 : -1, "aria-disabled": p2 === true ? true : void 0, "aria-selected": S.value, disabled: void 0, onMousedown: D, onFocus: E2, onPointerenter: M, onMouseenter: M, onPointermove: $2, onMousemove: $2, onPointerleave: B, onMouseleave: B }, i2 = T$2(a, ["order", "value"]);
...
let Ie = defineComponent({ name: "Listbox", emits: { "update:modelValue": (o2) => true }, props: { as: { type: [Object, String], default: "template" }, disabled: { type: [Boolean], default: false }, by: { type: [String, Function], default: () => pe }, horizontal: { type: [Boolean], default: false }, modelValue: { type: [Object, String, Number, Boolean], default: void 0 }, defaultValue: { type: [Object, String, Number, Boolean], default: void 0 }, form: { type: String, optional: true }, name: { type: String, optional: true }, multiple: { type: [Boolean], default: false } }, inheritAttrs: false, setup(o2, { slots: b, attrs: r, emit: w$2$1 }) {
  ...
  let D = computed(() => o2.multiple ? 1 : 0), [y, L] = d(computed(() => o2.modelValue), (t2) => w$2$1("update:modelValue", t2), computed(() => o2.defaultValue)), M = computed(() => y.value === void 0 ? u$7(D.value, { [1]: [], [0]: void 0 }) : y.value), k = { listboxState: n2, value: M, mode: D, compare(t2, i2) {
  ...
  w$2([f2, v], (t2, i2) => {
    var l2;
    k.closeListbox(), w$4(i2, h.Loose) || (t2.preventDefault(), (l2 = o$2(f2)) == null || l2.focus());
  ...
  return onMounted(() => {
    ...
    return h$1(Fragment, [...t2 != null && M.value != null ? e({ [t2]: M.value }).map(([I, Q]) => h$1(f$2, E$2({ features: u$4.Hidden, key: I, as: "input", type: "hidden", hidden: true, readOnly: true, form: d2, disabled: l2, name: I, value: Q }))) : [], A$3({ ourProps: {}, theirProps: { ...r, ...T$2(O2, ["defaultValue", "onUpdate:modelValue", "horizontal", "multiple", "by"]) }, slot: h$12, slots: b, attrs: r, name: "Listbox" })]);
  };
} });
...
const _sfc_main$1 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    const fields = [{
      name: "email",
      label: t2("authform.inputs.email.label"),
      type: "text",
      placeholder: t2("authform.inputs.email.placeholder"),
      value: form.email
    }, {
      name: "password",
      label: t2("authform.inputs.password.label"),
      type: "password",
      placeholder: t2("authform.inputs.password.placeholder"),
      value: form.password
    }];
    const validate = (state) => {
      const errors = [];
      if (!state.email) errors.push({ path: "email", message: t2("authform.inputs.email.err") });
      if (!state.password) errors.push({ path: "password", message: t2("authform.inputs.password.err") });
      return errors;
    };
    async function onSubmit(data) {
      try {
        const response = await axios.post("https://saci.key2host.com/api/auth/login", {
          email: data.email,
        ...
        if (error.response && error.response.status === 401) {
          ...
          errorMessage.value = t2("authform.errorModal.wrongCred");
        } else if (error.response && error.response.status === 403) {
          console.error("Fehler bei der Anmeldung", error);
          errorMessage.value = t2("authform.errorModal.suspended");
        } else {
          console.error("Fehler bei der API-Anfrage:", error.message);
          errorMessage.value = t2("authform.errorModal.err");
        }
        toast.add({
          ...
          color: "red",
          timeout: 2500,
          title: t2("authform.errorModal.title")
        });
      }
    }
    return (_ctx, _push, _parent, _attrs) => {
  ...
  async setup(__props) {
    ...
    async function buy() {
      ...
      try {
        ...
        toast.add({
          icon: "i-heroicons-exclamation-triangle",
          description: t2("checkout.index.errorModal.description"),
          color: "red",
          title: t2("checkout.index.errorModal.title"),
          timeout: 5e3,
    ...
    fetchData();
    useSeoMeta({
      title: t2("checkout.index.title"),
      ogTitle: t2("checkout.index.title"),
      description: t2("checkout.index.description"),
      ogDescription: t2("checkout.index.description"),
    ...
    return (_ctx, _push, _parent, _attrs) => {
                ...
                _push2(ssrRenderComponent(_component_UCard, null, {
                  default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                    if (_push3) {
                      ...
                      _push3(`<hr class="my-2"${_scopeId2}><div class="flex justify-between font-semibold"${_scopeId2}><span${_scopeId2}>Gesamt:</span><span${_scopeId2}>${ssrInterpolate(unref(cart).totalPrice)} €</span></div><div class="mt-4"${_scopeId2}><button class="mt-2 w-full bg-blue-600 text-white py-2 rounded-md hover:bg-blue-700"${_scopeId2}>Zur Bezahlung</button></div>`);
                    } else {
                      return [
      ...
      if (unref(step) == 2) {
        _push(`<small class="opacity-75">${ssrInterpolate(_ctx.$t("checkout.index.steps.2.loggedInAs"))} ${ssrInterpolate(unref(userName) || _ctx.$t("checkout.index.steps.2.unknownUser"))}. <span class="text-primary underline">${ssrInterpolate(_ctx.$t("checkout.index.steps.2.notYou"))}?</span></small>`);
      } else {
        _push(`<!---->`);
      }
      _push(`</div></div>`);
...
//# sourceMappingURL=index-UpbOmHJc.mjs.map
