...
import { _ as __nuxt_component_2 } from './PageCard-DQy-NHsA.mjs';
...
const __nuxt_component_9 = Object.assign(_sfc_main$1, { __name: "ULandingFAQ" });
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      const _component_ULandingFAQ = __nuxt_component_9;
            ...
            _push2(ssrRenderComponent(_component_UPageCard, {
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  ...
                  _push3(ssrRenderComponent(_component_NuxtTurnstile, null, null, _parent3, _scopeId2));
                  _push3(`<button type="submit" class="bg-blue-600 text-white px-4 py-2 rounded-md hover:bg-blue-700 transition"${ssrIncludeBooleanAttr(messageSent.value) ? " disabled" : ""}${_scopeId2}>${ssrInterpolate(_ctx.$t("contact.contactform.inputs.submit"))}</button></form>`);
                } else {
                  return [
                    createVNode("form", {
...
//# sourceMappingURL=contact-BFnOoJqd.mjs.map
